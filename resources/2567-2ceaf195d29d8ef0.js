  ...
  [2567],
  {
    22567: function (e, t, n) {
      ...
      let l = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }),
        o = Object.freeze({ rotate: 0, vFlip: !1, hFlip: !1 }),
        a = Object.freeze({ ...l, ...o }),
        c = Object.freeze({ ...a, body: "", hidden: !1 });
      function s(e, t) {
        let n = (function (e, t) {
          let n = {};
      ...
      let u = { provider: "", aliases: {}, not_found: {}, ...l };
      function p(e, t) {
      ...
      function d(e) {
        ...
        for (let e in t) {
          let n = t[e];
          if (!e || "string" != typeof n.body || !p(n, c)) return null;
        }
        let n = e.aliases || Object.create(null);
        for (let e in n) {
          let r = n[e],
            i = r.parent;
          if (!e || "string" != typeof i || (!t[i] && !n[i]) || !p(r, c))
            return null;
        }
        return e;
      }
      let h = /^[a-z0-9]+(-[a-z0-9]+)*$/,
        g = (e, t, n, r = "") => {
          ...
          if (i.length > 1) {
            let e = i.pop(),
              n = i.pop(),
              l = { provider: i.length > 0 ? i[0] : r, prefix: n, name: e };
            return t && !m(l) ? null : l;
          }
          let l = i[0],
            o = l.split("-");
          ...
          if (n && "" === r) {
            let e = { provider: r, prefix: "", name: l };
      ...
      function k(e) {
        let t = "string" == typeof e ? g(e, !0, x) : e;
        if (t) {
      ...
      function F(e, t, n) {
        ...
        for (;;) {
          if (o) {
            let e = parseFloat(l);
            isNaN(e) ? i.push(l) : i.push(Math.ceil(e * t * n) / n);
          } else i.push(l);
          if (void 0 === (l = r.shift())) return i.join("");
          o = !o;
        }
      }
      ...
      for (; R.length > 0; )
        1 === R.length
          ...
          : Math.random() > 0.5
            ? P.push(R.shift())
            : P.push(R.pop());
      z[""] = N({ resources: ["https://api.iconify.design"].concat(P) });
      let A = (() => {
        let e;
        try {
      ...
      function H(e) {
        ...
        return {
          query: function (e, i, l) {
            let o = (function (e, t, n, r) {
              let i, l;
              let o = e.resources.length,
                  ...
                  setTimeout(() => {
                    ...
                    t.forEach((t) => {
                      ...
                      ((l.pending = l.pending.filter((t) => {
                        ...
                        let o = t.name;
                        if (e.icons[o])
                          l.loaded.push({ provider: r, prefix: i, name: o });
                        else {
                          if (!e.missing.has(o)) return ((n = !0), !0);
                          l.missing.push({ provider: r, prefix: i, name: o });
                        }
                        return !1;
                      })),
                        l.pending.length !== o &&
      ...
      let W = (e, t) => {
          ...
          let i = (function (e, t = !0, n = !1) {
              ...
              return (
                e.forEach((e) => {
                  let i = "string" == typeof e ? g(e, t, n) : e;
                  i && r.push(i);
                }),
                r
              );
                ...
                e.forEach((e) => {
                  ...
                  (o in c.icons
                    ...
                    : "" === l || c.missing.has(o)
                      ? t.missing
                      : t.pending
                  ).push({ provider: i, prefix: l, name: o });
                }),
                t
              );
            })(i);
          if (!l.pending.length) {
            ...
            return (
              t &&
                setTimeout(() => {
                  e && t(l.loaded, l.missing, l.pending, J);
                }),
              () => {
                e = !1;
              }
          ...
          return (
            l.pending.forEach((e) => {
              ...
              if (i === r && t === n) return;
              ((n = t), (r = i), a.push(y(t, i)));
              let l = o[t] || (o[t] = Object.create(null));
              l[i] || (l[i] = []);
            }),
            l.pending.forEach((e) => {
              ...
              t.length &&
                ...
                e.iconsQueueFlag ||
                  ...
                  setTimeout(() => {
                    ...
                    let { valid: l, invalid: o } = (function (e) {
                      let t = [],
                        n = [];
                      return (
                        e.forEach((e) => {
                    ...
                    if ((o.length && Q(e, o, null), !l.length)) return;
                    let a = n.match(h) ? _(t) : null;
                    if (!a) {
                      Q(e, l, null);
                      return;
                    }
                    let c = a.prepare(t, n, l);
                    c.forEach((n) => {
                      !(function (e, t, n) {
                        let r, i;
                        if ("string" == typeof e) {
            ...
            t
              ? (function (e, t, n) {
                  ...
                  let l = { id: r, icons: t, callback: e, abort: i };
                  return (
                    n.forEach((e) => {
        ...
        Y = { backgroundColor: "currentColor" },
        Z = { backgroundColor: "transparent" },
        ee = { Image: "var(--svg)", Repeat: "no-repeat", Size: "100% 100%" },
        et = { WebkitMask: Y, mask: Y, background: Z };
      for (let e in et) {
        let t = et[e];
        for (let n in ee) t[e + n] = ee[n];
      }
      let en = { ...G, inline: !0 };
      function er(e) {
      ...
      let ei = (e, t, n) => {
        ...
        let p = (function (e, t) {
              ...
              switch (
                (r
                  ...
                  : i &&
                    ...
                    n.push("scale(1 -1)"),
                    (o.top = o.left = 0)),
                l < 0 && (l -= 4 * Math.floor(l / 4)),
                (l %= 4))
              ) {
                case 1:
                  n.unshift(
                    "rotate(90 " +
                      (t = o.height / 2 + o.top).toString() +
                      " " +
                      t.toString() +
                      ")",
                  );
            ...
            let s = l.width,
              ...
              p = o.height;
            null === s
              ? (n = F((r = null === f ? "1em" : "auto" === f ? p : f), u / p))
              : ((n = "auto" === s ? u : s),
                (r = null === f ? F(n, p / u) : "auto" === f ? p : f));
            let d = {},
              h = (e, t) => {
                T(t) || (d[e] = t.toString());
              };
            (h("width", n), h("height", r));
            let g = [o.left, o.top, u, p];
            return (
              (d.viewBox = g.join(" ")),
              { attributes: d, viewBox: g, body: c }
            );
          })(e, o),
          d = p.attributes;
        if ((o.inline && (s.verticalAlign = "-0.125em"), "svg" === c)) {
          var h;
          ((u.style = { ...s, ...f }), Object.assign(u, d));
          let e = 0,
            n = t.id;
          return (
              ...
              __html:
                ((h = (function (e, t = C) {
                  ...
                  return (
                    r.forEach((n) => {
                      let r =
                          "function" == typeof t ? t(n) : t + (L++).toString(),
                        l = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
                      e = e.replace(
                        RegExp('([#;"])(' + l + ')([")]|\\.[a-z])', "g"),
                        "$1" + r + i + "$3",
            ...
            (0, i.createElement)("svg", u)
          );
        }
        let { body: m, width: b, height: y } = e,
          v = "mask" === c || ("bg" !== c && -1 !== m.indexOf("currentColor")),
          x = (function (e, t) {
            let n =
              -1 === e.indexOf("xlink:")
                ? ""
        ...
        (M[""] = {
          prepare: (e, t, n) => {
            let r = [],
              ...
              l = "icons",
              o = { type: l, provider: e, prefix: t, icons: [] },
              a = 0;
            return (
              n.forEach((n, c) => {
                ((a += n.length + 1) >= i &&
      ...
      function el(e) {
        ...
        function f(e) {
          if (JSON.stringify(o) !== JSON.stringify(e)) return (s(), c(e), !0);
        }
        ((0, i.useEffect)(() => (n(!0), s), []),
          (0, i.useEffect)(() => {
            t &&
              (function t() {
                ...
                if (f({ name: r, data: i })) {
                  if (void 0 === i) {
                    ...
                    i &&
                      (null === (n = e.onLoad) || void 0 === n || n.call(e, r));
                }
              })();
          }, [e.icon, t]));
        let { name: u, data: p } = o;
      ...
      let eo = (0, i.forwardRef)((e, t) => el({ ...e, _ref: t }));
      (0, i.forwardRef)((e, t) => el({ inline: !0, ...e, _ref: t }));
    },
  },
]);
