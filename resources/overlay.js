google.maps.__gjsload__("overlay", function (_) {
  var Pza = function () {},
    ...
    Sza = function (a, b) {
      ...
      e = () => _.Gq(d.Dg);
      c.Dg = [
        _.yn(a, "panes_changed", e),
        _.yn(f, "zoom_changed", e),
        _.yn(f, "offset_changed", e),
        _.yn(b, "projection_changed", e),
        _.yn(f, "projectioncenterq_changed", e),
      ];
      _.Gq(d.Dg);
      b instanceof _.ho
        ? (_.zo(b, "Ox"), _.M(b, 148440))
        : b instanceof _.bp && (_.zo(b, "Oxs"), _.M(b, 181451));
    },
    Tza = function (a) {
      const b = mI(a);
      var c = b.Gg;
      ...
      b.Dg = null;
      b.Eg && (_.Hq(b.Eg.Dg), (b.Eg = null));
    },
    Yza = function (a) {
      if (a) {
        var b = a.getMap();
        if (Uza(a) !== b && b && b instanceof _.ho) {
          const c = b.__gm;
          c.overlayLayer
            ? (a.__gmop = new Vza(b, a, c.overlayLayer))
            : c.Eg.then(({ ah: d }) => {
                const e = new Wza(b, d);
                d.Pi(e);
                c.overlayLayer = e;
  ...
  var Vza = class {
    ...
    Wza = class {
      ...
      dispose() {}
      Ih(a, b, c, d, e, f, g, h) {
        const k = (this.Dg = this.Dg || new _.NB(this.map, this.ah, () => {}));
        k.Ih(a, b, c, d, e, f, g, h);
        for (const m of this.Eg) (Zza(m, k), m.draw());
      }
      Pn(a) {
        this.Eg.push(a);
        this.Dg && Zza(a, this.Dg);
        this.ah.refresh();
      }
      wo(a) {
        _.Ub(this.Eg, a);
  ...
  _.Ml("overlay", {
      ...
      if (a) {
        ...
        b &&
          (b instanceof _.ho
            ...
            : a &&
              ((b = a.getMap()),
              (mI(a).Hg || null) !== b && (b && Sza(a, b), (mI(a).Hg = b))));
      }
    },
    ...
    preventMapHitsAndGesturesFrom: (a) => {
      ...
      a.addEventListener("mousemove", _.wn);
