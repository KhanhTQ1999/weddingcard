  ...
  [2552],
  {
    57156: function (e) {
      function t(e, t = 100, r = {}) {
        ...
        let { immediate: s } = "boolean" == typeof r ? { immediate: r } : r;
        function d() {
          let t = o,
            r = a;
          return ((o = void 0), (a = void 0), (i = e.apply(t, r)));
        }
        function c() {
          let e = Date.now() - l;
          e < t && e >= 0
        ...
        let u = function (...e) {
          ...
          ((o = this), (a = e), (l = Date.now()));
          let r = s && !n;
          return (n || (n = setTimeout(c, t)), r && (i = d()), i);
        };
        return (
          (u.clear = () => {
    ...
    88388: function (e, t, r) {
      ...
      var o =
        ...
        d = function (e, t, r) {
          ...
          return (t && n.call(e, o) && a.unshift(e), (a = a.filter(r)));
        },
        c = function e(t, r, a) {
          for (var l = [], s = Array.from(t); s.length; ) {
            var d = s.shift();
            if (!i(d, !1)) {
              if ("SLOT" === d.tagName) {
                var c = d.assignedElements(),
                  u = e(c.length ? c : d.children, !0, a);
                a.flatten
                  ? l.push.apply(l, u)
                  : l.push({ scopeParent: d, candidates: u });
              } else {
                n.call(d, o) &&
                  a.filter(d) &&
                  (r || !t.includes(d)) &&
                ...
                var g =
                    d.shadowRoot ||
                    ("function" == typeof a.getShadowRoot &&
                      a.getShadowRoot(d)),
                  b =
                    !i(g, !1) && (!a.shadowRootFilter || a.shadowRootFilter(d));
                if (g && b) {
                  var f = e(!0 === g ? d.children : g.children, !0, a);
                  a.flatten
                    ? l.push.apply(l, f)
                    : l.push({ scopeParent: d, candidates: f });
                } else s.unshift.apply(s, d.children);
              }
            }
          }
          return l;
        ...
        y = function (e) {
          var t,
            ...
            s,
            d = e && l(e),
            c = null === (t = d) || void 0 === t ? void 0 : t.host,
            u = !1;
          if (d && d !== e)
            for (
              u = !!(
              ...
              u = !!(
                null !==
                  (i = c =
                    null === (n = d = l(c)) || void 0 === n
                      ? void 0
                      : n.host) &&
                void 0 !== i &&
                null !== (s = i.ownerDocument) &&
                void 0 !== s &&
                s.contains(c)
              );
          return u;
        ...
        w = function (e, t) {
          ...
          var a = n.call(e, "details>summary:first-of-type")
            ? e.parentElement
            : e;
          if (n.call(a, "details:not([open]) *")) return !0;
          if (r && "full" !== r && "legacy-full" !== r) {
            if ("non-zero-area" === r) return x(e);
          } else {
            if ("function" == typeof o) {
              for (var i = e; e; ) {
                var s = e.parentElement,
                  d = l(e);
                if (s && !s.shadowRoot && !0 === o(s)) return x(e);
                e = e.assignedSlot
                  ? e.assignedSlot
                  : s || d === e.ownerDocument
                    ? s
            ...
            for (var t = e.parentElement; t; ) {
              if ("FIELDSET" === t.tagName && t.disabled) {
                for (var r = 0; r < t.children.length; r++) {
                  ...
                  if ("LEGEND" === o.tagName)
                    return (
                      !!n.call(t, "fieldset[disabled] *") || !o.contains(e)
                    );
                }
                return !0;
              }
        ...
        T = function (e, t) {
          return C(
            (t = t || {}).getShadowRoot
              ...
              : d(e, t.includeContainer, j.bind(null, t)),
          );
        },
        S = function (e, t) {
          return (t = t || {}).getShadowRoot
            ...
            : d(e, t.includeContainer, v.bind(null, t));
        },
        R = function (e, t) {
          if (((t = t || {}), !e)) throw Error("No node provided");
          return !1 !== n.call(e, o) && j(t, e);
        };
    },
    94712: function (e, t) {
      var r;
...
*/ !(function () {
              ...
              (e = n(
                ...
                (function (e) {
                  ...
                  if (
                    ...
                    return e.toString();
                  var t = "";
                  for (var r in e) o.call(e, r) && e[r] && (t = n(t, r));
                  return t;
                })(r),
              ));
          }
    ...
    58214: function (e, t, r) {
      ...
      function a(e, t, r) {
        let a,
          { reference: n, floating: l } = e,
          i = (0, o.Qq)(t),
          s = (0, o.Wh)(t),
          d = (0, o.I4)(s),
          c = (0, o.k3)(t),
          u = "y" === i,
          g = n.x + n.width / 2 - l.width / 2,
          b = n.y + n.height / 2 - l.height / 2,
          f = n[d] / 2 - l[d] / 2;
        switch (c) {
          case "top":
            a = { x: g, y: n.y - l.height };
            break;
          case "bottom":
      ...
      let n = async (e, t, r) => {
        let {
          ...
          s = l.filter(Boolean),
          d = await (null == i.isRTL ? void 0 : i.isRTL(t)),
        ...
        return { x: u, y: g, placement: b, strategy: n, middlewareData: f };
      };
      async function l(e, t) {
        var r;
        void 0 === t && (t = {});
        let { x: a, y: n, platform: l, rects: i, elements: s, strategy: d } = e,
          {
          ...
          p = (0, o.yd)(f),
          h = s[b ? ("floating" === g ? "reference" : "floating") : g],
          m = (0, o.JB)(
            await l.getClippingRect({
              element:
                null ==
                  (r = await (null == l.isElement ? void 0 : l.isElement(h))) ||
                r
                  ? h
                  : h.contextElement ||
          ...
          w = ((await (null == l.isElement ? void 0 : l.isElement(x))) &&
        ...
        return {
          top: (m.top - k.top + p.top) / w.y,
          bottom: (k.bottom - m.bottom + p.bottom) / w.y,
          left: (m.left - k.left + p.left) / w.x,
      ...
      function s(e) {
        return o.mA.some((t) => e[t] >= 0);
      }
      function d(e) {
        let t = (0, o.VV)(...e.map((e) => e.left)),
          r = (0, o.VV)(...e.map((e) => e.top)),
          a = (0, o.Fp)(...e.map((e) => e.right)),
          n = (0, o.Fp)(...e.map((e) => e.bottom));
        return { x: t, y: r, width: a - t, height: n - r };
      }
      let c = new Set(["left", "top"]);
      async function u(e, t) {
        let { placement: r, platform: a, elements: n } = e,
          l = await (null == a.isRTL ? void 0 : a.isRTL(n.floating)),
          i = (0, o.k3)(r),
          s = (0, o.hp)(r),
          d = "y" === (0, o.Qq)(r),
          u = c.has(i) ? -1 : 1,
      ...
      function b(e) {
        let t = (0, g.Dx)(e),
          ...
          s = (0, o.NM)(r) !== l || (0, o.NM)(a) !== i;
        return (s && ((r = l), (a = i)), { width: r, height: a, $: s });
      }
      function f(e) {
        return (0, g.kK)(e) ? e : e.contextElement;
      }
      function p(e) {
        let t = f(e);
        if (!(0, g.Re)(t)) return (0, o.ze)(1);
        let r = t.getBoundingClientRect(),
          { width: a, height: n, $: l } = b(t),
          i = (l ? (0, o.NM)(r.width) : r.width) / a,
          s = (l ? (0, o.NM)(r.height) : r.height) / n;
        return (
      ...
      function m(e) {
        let t = (0, g.Jj)(e);
        return (0, g.Pf)() && t.visualViewport
      ...
      function y(e, t, r, a) {
        ...
        let l = e.getBoundingClientRect(),
          i = f(e),
          s = (0, o.ze)(1);
        t && (a ? (0, g.kK)(a) && (s = p(a)) : (s = p(e)));
        let d = (void 0 === (n = r) && (n = !1),
          a && (!n || a === (0, g.Jj)(i)) && n)
            ? m(i)
            : (0, o.ze)(0),
          c = (l.left + d.x) / s.x,
        ...
        if (i) {
          ...
          for (; o && a && t !== r; ) {
            let e = p(o),
              ...
              a = (0, g.Dx)(o),
              n = t.left + (o.clientLeft + parseFloat(a.paddingLeft)) * e.x,
              l = t.top + (o.clientTop + parseFloat(a.paddingTop)) * e.y;
            ((c *= e.x),
              (u *= e.y),
              (b *= e.x),
              (h *= e.y),
        ...
        return (0, o.JB)({ width: b, height: h, x: c, y: u });
      }
      function x(e, t) {
        let r = (0, g.Lw)(e).scrollLeft;
        return t ? t.left + r : y((0, g.tF)(e)).left + r;
      }
      function w(e, t, r) {
        void 0 === r && (r = !1);
        let o = e.getBoundingClientRect(),
          a = o.left + t.scrollLeft - (r ? 0 : x(e, o)),
          n = o.top + t.scrollTop;
        return { x: a, y: n };
      }
      let k = new Set(["absolute", "fixed"]);
      function v(e, t, r) {
        let a;
        if ("viewport" === t)
          a = (function (e, t) {
            let r = (0, g.Jj)(e),
              ...
              s = 0;
            if (a) {
              ((n = a.width), (l = a.height));
              let e = (0, g.Pf)();
              (!e || (e && "fixed" === t)) &&
                ((i = a.offsetLeft), (s = a.offsetTop));
            }
            return { width: n, height: l, x: i, y: s };
          })(e, r);
        else if ("document" === t)
          a = (function (e) {
            let t = (0, g.tF)(e),
              ...
              s = -r.scrollTop;
            return (
              "rtl" === (0, g.Dx)(a).direction &&
                (i += (0, o.Fp)(t.clientWidth, a.clientWidth) - n),
              { width: n, height: l, x: i, y: s }
            );
          })((0, g.tF)(e));
        else if ((0, g.kK)(t))
          a = (function (e, t) {
            let r = y(e, !0, "fixed" === t),
              ...
              l = (0, g.Re)(e) ? p(e) : (0, o.ze)(1),
              i = e.clientWidth * l.x,
              s = e.clientHeight * l.y,
              d = n * l.x,
              c = a * l.y;
            return { width: i, height: s, x: d, y: c };
          })(t, r);
        else {
          let r = m(e);
      ...
      function j(e) {
        return "static" === (0, g.Dx)(e).position;
      }
      function N(e, t) {
        if (!(0, g.Re)(e) || "fixed" === (0, g.Dx)(e).position) return null;
        if (t) return t(e);
        let r = e.offsetParent;
        return ((0, g.tF)(e) === r && (r = r.ownerDocument.body), r);
      }
      function C(e, t) {
        let r = (0, g.Jj)(e);
        if ((0, g.tR)(e)) return r;
        if (!(0, g.Re)(e)) {
          let t = (0, g.Ow)(e);
          for (; t && !(0, g.Py)(t); ) {
            if ((0, g.kK)(t) && !j(t)) return t;
            t = (0, g.Ow)(t);
          }
          return r;
        }
        let o = N(e, t);
        for (; o && (0, g.Ze)(o) && j(o); ) o = N(o, t);
        return o && (0, g.Py)(o) && j(o) && !(0, g.hT)(o)
          ? r
          : o || (0, g.gQ)(e) || r;
      }
      let T = async function (e) {
          ...
          return {
            reference: (function (e, t, r) {
              ...
              l && !a && n && (d.x = x(n));
              let c = !n || a || l ? (0, o.ze)(0) : w(n, s),
                u = i.left + s.scrollLeft - d.x - c.x,
                b = i.top + s.scrollTop - d.y - c.y;
              return { x: u, y: b, width: i.width, height: i.height };
        ...
        S = {
          convertOffsetParentRelativeRectToViewportRelativeRect: function (e) {
            let { elements: t, rect: r, offsetParent: a, strategy: n } = e,
              l = "fixed" === n,
              i = (0, g.tF)(a),
              s = !!t && (0, g.tR)(t.floating);
            if (a === i || (s && l)) return r;
            ...
            if (
              (b || (!b && !l)) &&
              (("body" !== (0, g.wk)(a) || (0, g.ao)(i)) && (d = (0, g.Lw)(a)),
              (0, g.Re)(a))
            ) {
              let e = y(a);
              ((c = p(a)),
            ...
            let f = !i || b || l ? (0, o.ze)(0) : w(i, d, !0);
            return {
              width: r.width * c.x,
              height: r.height * c.y,
              x: r.x * c.x - d.scrollLeft * c.x + u.x + f.x,
              y: r.y * c.y - d.scrollTop * c.y + u.y + f.y,
            };
          },
          getDocumentElement: g.tF,
          getClippingRect: function (e) {
            let { element: t, boundary: r, rootBoundary: a, strategy: n } = e,
              l =
                "clippingAncestors" === r
                  ? (0, g.tR)(t)
                    ? []
                    : (function (e, t) {
                        let r = t.get(e);
                        if (r) return r;
                        let o = (0, g.Kx)(e, [], !1).filter(
                            (e) => (0, g.kK)(e) && "body" !== (0, g.wk)(e),
                          ),
                          a = null,
                          n = "fixed" === (0, g.Dx)(e).position,
                          l = n ? (0, g.Ow)(e) : e;
                        for (; (0, g.kK)(l) && !(0, g.Py)(l); ) {
                          let t = (0, g.Dx)(l),
                            r = (0, g.hT)(l);
                          r || "fixed" !== t.position || (a = null);
                          let i = n
                            ? !r && !a
                            : (!r &&
                                "static" === t.position &&
                              ...
                              ((0, g.ao)(l) &&
                                ...
                                (function e(t, r) {
                                  ...
                                  return (
                                    ...
                                    ("fixed" === (0, g.Dx)(o).position ||
                                      e(o, r))
                                  );
                                })(e, l));
                          (i ? (o = o.filter((e) => e !== l)) : (a = t),
                            (l = (0, g.Ow)(l)));
                        }
                        return (t.set(e, o), o);
                      })(t, this._c)
              ...
              d = i.reduce(
                (e, r) => {
                  let a = v(t, r, n);
                  return (
                    (e.top = (0, o.Fp)(a.top, e.top)),
                    (e.right = (0, o.VV)(a.right, e.right)),
                    (e.bottom = (0, o.VV)(a.bottom, e.bottom)),
                    (e.left = (0, o.Fp)(a.left, e.left)),
                    e
                  );
                },
                v(t, s, n),
          ...
          getDimensions: function (e) {
            let { width: t, height: r } = b(e);
            return { width: t, height: r };
          },
          getScale: p,
          isElement: g.kK,
          isRTL: function (e) {
            return "rtl" === (0, g.Dx)(e).direction;
          },
        };
      function R(e, t) {
        return (
      ...
      function E(e, t, r, a) {
                  ...
                  return (
                    !(function i(s, d) {
                      ...
                      let c = e.getBoundingClientRect(),
                        { left: u, top: g, width: b, height: f } = c;
                      if ((s || t(), !b || !f)) return;
                      let p = (0, o.GW)(g),
                        h = (0, o.GW)(n.clientWidth - (u + b)),
                        m = (0, o.GW)(n.clientHeight - (g + f)),
                        y = (0, o.GW)(u),
                        x = {
                          rootMargin:
                            -p + "px " + -h + "px " + -m + "px " + -y + "px",
                          threshold: (0, o.Fp)(0, (0, o.VV)(1, d)) || 1,
                        },
                        w = !0;
                      function k(t) {
                        ...
                        (1 !== o || R(c, e.getBoundingClientRect()) || i(),
                          (w = !1));
                      }
                      try {
                        ...
                        a = new IntersectionObserver(k, x);
                      }
                      a.observe(e);
                    })(!0),
                    l
        ...
        return (
          c &&
            (function t() {
              let o = y(e);
              (x && !R(x, o) && r(), (x = o), (n = requestAnimationFrame(t)));
            })(),
          r(),
          () => {
            var e;
        ...
        z = function (e) {
          return (
            void 0 === e && (e = 0),
            {
              ...
              async fn(t) {
                var r, o;
                let { x: a, y: n, placement: l, middlewareData: i } = t,
                  s = await u(t, e);
                return l === (null == (r = i.offset) ? void 0 : r.placement) &&
                  null != (o = i.arrow) &&
                  o.alignmentOffset
                  ? {}
                  : { x: a + s.x, y: n + s.y, data: { ...s, placement: l } };
              },
            }
          );
        },
          ...
          return (
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                  ...
                  m =
                    void 0 !== b || f === o.Ct
                      ? (function (e, t, r) {
                          let a = e
                            ? [
                                ...r.filter((t) => (0, o.hp)(t) === e),
                                ...r.filter((t) => (0, o.hp)(t) !== e),
                              ]
                            : r.filter((e) => (0, o.k3)(e) === e);
                          return a.filter(
                            (r) =>
                              !e ||
                              (0, o.hp)(r) === e ||
                      ...
                      : f,
                  y = await l(t, h),
                  x = (null == (r = s.autoPlacement) ? void 0 : r.index) || 0,
                  w = m[x];
                if (null == w) return {};
                let k = (0, o.i8)(
                  w,
                ...
                if (d !== w) return { reset: { placement: m[0] } };
                let v = [y[(0, o.k3)(w)], y[k[0]], y[k[1]]],
                  j = [
                    ...((null == (a = s.autoPlacement)
                      ? void 0
                      : a.overflows) || []),
                    { placement: w, overflows: v },
                  ],
                  N = m[x + 1];
                if (N)
                  return {
                    data: { index: x + 1, overflows: j },
                    reset: { placement: N },
                  };
                let C = j
                    .map((e) => {
                      let t = (0, o.hp)(e.placement);
                      return [
                        e.placement,
                        t && g
                    ...
                    .sort((e, t) => e[1] - t[1]),
                  T = C.filter((e) =>
                    e[2].slice(0, (0, o.hp)(e[0]) ? 2 : 3).every((e) => e <= 0),
                  ),
                  S = (null == (n = T[0]) ? void 0 : n[0]) || C[0][0];
                return S !== d
                  ? {
                      data: { index: x + 1, overflows: j },
                      reset: { placement: S },
            ...
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                let { x: r, y: a, placement: n } = t,
                  ...
                  h = u[b];
                if (i) {
                  let e = p + g["y" === f ? "top" : "left"],
                    t = p - g["y" === f ? "bottom" : "right"];
                  p = (0, o.uZ)(e, p, t);
                }
                if (s) {
                  let e = "y" === b ? "top" : "left",
                ...
                let m = d.fn({ ...t, [f]: p, [b]: h });
                return {
                  ...m,
                  data: { x: m.x - r, y: m.y - a, enabled: { [f]: i, [b]: s } },
                };
              },
            }
          );
            ...
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                ...
                let v = (0, o.k3)(d),
                  j = (0, o.Qq)(g),
                  N = (0, o.k3)(g) === g,
                  C = await (null == b.isRTL ? void 0 : b.isRTL(f.floating)),
                  T = m || (N || !w ? [(0, o.pw)(g)] : (0, o.gy)(g)),
                  S = "none" !== x;
                !m && S && T.push(...(0, o.KX)(g, w, x, C));
                let R = [g, ...T],
                  E = await l(t, k),
                  D = [],
                  z = (null == (a = c.flip) ? void 0 : a.overflows) || [];
                if ((p && D.push(E[v]), h)) {
                  let e = (0, o.i8)(d, u, C);
                  D.push(E[e[0]], E[e[1]]);
                }
                if (
                  ((z = [...z, { placement: d, overflows: D }]),
                  !D.every((e) => e <= 0))
                ) {
                  let e = ((null == (n = c.flip) ? void 0 : n.index) || 0) + 1,
                    t = R[e];
                  if (t) {
                    let r = "alignment" === h && j !== (0, o.Qq)(t);
                    if (
                      !r ||
                      z.every(
                        (e) =>
                          e.overflows[0] > 0 && (0, o.Qq)(e.placement) === j,
                      )
                    )
                      return {
          ...
          return (
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                var r, a;
                let n, i;
                let { placement: s, rects: d, platform: c, elements: u } = t,
                  { apply: g = () => {}, ...b } = (0, o.ku)(e, t),
                  f = await l(t, b),
                  p = (0, o.k3)(s),
                  h = (0, o.hp)(s),
                  m = "y" === (0, o.Qq)(s),
                  { width: y, height: x } = d.floating;
                "top" === p || "bottom" === p
                  ? ((n = p),
                    (i =
                      h ===
                  ...
                  m
                    ? (T =
                        ...
                        2 *
                          (0 !== e || 0 !== t
                            ? e + t
                            : (0, o.Fp)(f.left, f.right)))
                    : (C =
                        x -
                        2 *
                          (0 !== r || 0 !== a
                            ? r + a
                            : (0, o.Fp)(f.top, f.bottom)));
                }
                await g({ ...t, availableWidth: T, availableHeight: C });
                let S = await c.getDimensions(u.floating);
                return y !== S.width || x !== S.height
                  ? { reset: { rects: !0 } }
                  : {};
              },
            }
        ...
        O = function (e) {
          return (
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                let { rects: r } = t,
                  { strategy: a = "referenceHidden", ...n } = (0, o.ku)(e, t);
                switch (a) {
                  case "referenceHidden": {
                    let e = await l(t, { ...n, elementContext: "reference" }),
                      o = i(e, r.reference);
                    return {
                      data: {
                  ...
                  case "escaped": {
                    let e = await l(t, { ...n, altBoundary: !0 }),
                      o = i(e, r.floating);
                    return { data: { escapedOffsets: o, escaped: s(o) } };
                  }
                  default:
                    return {};
                }
        ...
        F = (e) => ({
          ...
          async fn(t) {
            let {
              ...
              { element: c, padding: u = 0 } = (0, o.ku)(e, t) || {};
            if (null == c) return {};
            let g = (0, o.yd)(u),
              b = { x: r, y: a },
              f = (0, o.Wh)(n),
              ...
              x = l.reference[p] + l.reference[f] - b[f] - l.floating[p],
              w = b[f] - l.reference[f],
              k = await (null == i.getOffsetParent
                ? void 0
                : i.getOffsetParent(c)),
              v = k ? k[y] : 0;
            (v && (await (null == i.isElement ? void 0 : i.isElement(k)))) ||
              (v = s.floating[y] || l.floating[p]);
            let j = v / 2 - h[p] / 2 - 1,
              N = (0, o.VV)(g[m ? "top" : "left"], j),
              C = (0, o.VV)(g[m ? "bottom" : "right"], j),
              T = v - h[p] - C,
              S = v / 2 - h[p] / 2 + (x / 2 - w / 2),
              R = (0, o.uZ)(N, S, T),
              E =
                ...
                null != (0, o.hp)(n) &&
                S !== R &&
                l.reference[p] / 2 - (S < N ? N : C) - h[p] / 2 < 0,
              D = E ? (S < N ? S - N : S - T) : 0;
            return {
              [f]: b[f] + D,
              data: {
            ...
            void 0 === e && (e = {}),
            {
              ...
              async fn(t) {
                let {
                  ...
                  { padding: s = 2, x: c, y: u } = (0, o.ku)(e, t),
                  g = Array.from(
                    (await (null == l.getClientRects
                      ? void 0
                      : l.getClientRects(a.reference))) || [],
                  ),
                  b = (function (e) {
                    ...
                    for (let e = 0; e < t.length; e++) {
                      let o = t[e];
                      (!a || o.y - a.y > a.height / 2
                        ? r.push([o])
                        : r[r.length - 1].push(o),
                        (a = o));
                    }
                    return r.map((e) => (0, o.JB)(d(e)));
                  })(g),
                  f = (0, o.JB)(d(g)),
                  p = (0, o.yd)(s),
                    ...
                    reference: {
                      getBoundingClientRect: function () {
                        ...
                        if (b.length >= 2) {
                          ...
                          let e = "left" === (0, o.k3)(r),
                            t = (0, o.Fp)(...b.map((e) => e.right)),
                            a = (0, o.VV)(...b.map((e) => e.left)),
                            n = b.filter((r) =>
                              e ? r.left === a : r.right === t,
                            ),
                            l = n[0].top,
                            i = n[n.length - 1].bottom,
                            s = t - a;
                          return {
                            top: l,
                            bottom: i,
                ...
                return n.reference.x !== h.reference.x ||
                  n.reference.y !== h.reference.y ||
                  n.reference.width !== h.reference.width ||
                  n.reference.height !== h.reference.height
                  ? { reset: { rects: h } }
                  : {};
              },
            }
              ...
              fn(t) {
                ...
                if (d) {
                  let e = "y" === f ? "height" : "width",
                    t = l.reference[f] - l.floating[e] + y.mainAxis,
                    r = l.reference[f] + l.reference[e] - y.mainAxis;
                  p < t ? (p = t) : p > r && (p = r);
                }
                if (u) {
                  var x, w;
                  let e = "y" === f ? "width" : "height",
                    ...
                    r =
                      l.reference[b] -
                      l.floating[e] +
                      ((t && (null == (x = i.offset) ? void 0 : x[b])) || 0) +
                      (t ? 0 : y.crossAxis),
                    a =
                      l.reference[b] +
                      l.reference[e] +
                      (t ? 0 : (null == (w = i.offset) ? void 0 : w[b]) || 0) -
                      (t ? y.crossAxis : 0);
                  h < r ? (h = r) : h > a && (h = a);
                }
                return { [f]: p, [b]: h };
    ...
    1371: function (e, t, r) {
      ...
      var o = r(58214),
        a = r(67294),
        n = r(73935),
        l = "undefined" != typeof document ? a.useLayoutEffect : function () {};
      function i(e, t) {
        let r, o, a;
        if (e === t) return !0;
        ...
        if (e && t && "object" == typeof e) {
          if (Array.isArray(e)) {
            ...
            for (o = r; 0 != o--; ) if (!i(e[o], t[o])) return !1;
            return !0;
          }
          if ((r = (a = Object.keys(e)).length) !== Object.keys(t).length)
            return !1;
          for (o = r; 0 != o--; )
            if (!{}.hasOwnProperty.call(t, a[o])) return !1;
          for (o = r; 0 != o--; ) {
            let r = a[o];
      ...
      function u(e) {
        ...
        let {
            ...
            middleware: u = [],
            platform: g,
            elements: { reference: b, floating: f } = {},
            transform: p = !0,
        ...
        let [v, j] = a.useState(null),
          ...
          F = a.useCallback(() => {
            ...
            (L.current && (e.platform = L.current),
              (0, o.oo)(D.current, z.current, e).then((e) => {
        ...
        (l(
          ...
          l(() => {
            if ((R && (D.current = R), E && (z.current = E), R && E)) {
              if (P.current) return P.current(R, E, F);
              F();
            }
          }, [R, E, F, P, M]));
        let B = a.useMemo(
          ...
          W = a.useMemo(() => ({ reference: R, floating: E }), [R, E]),
          Y = a.useMemo(() => {
            ...
            return p
              ...
              : { position: r, left: t, top: o };
          }, [r, p, W.floating, y.x, y.y]);
        return a.useMemo(
          () => ({ ...y, update: F, refs: B, elements: W, floatingStyles: Y }),
          [y, F, B, W, Y],
        );
      }
      let g = (e) => ({
          ...
          options: e,
          fn(t) {
            let { element: r, padding: a } = "function" == typeof e ? e(t) : e;
            return r && {}.hasOwnProperty.call(r, "current")
              ? null != r.current
                ? (0, o.x7)({ element: r.current, padding: a }).fn(t)
                : {}
              : r
                ? (0, o.x7)({ element: r, padding: a }).fn(t)
                : {};
          },
        }),
        b = (e, t) => ({ ...(0, o.cv)(e), options: [e, t] }),
        f = (e, t) => ({ ...(0, o.uY)(e), options: [e, t] }),
        p = (e, t) => ({ ...(0, o.dr)(e), options: [e, t] }),
        h = (e, t) => ({ ...(0, o.RR)(e), options: [e, t] }),
        m = (e, t) => ({ ...(0, o.dp)(e), options: [e, t] }),
        y = (e, t) => ({ ...(0, o.X5)(e), options: [e, t] }),
        x = (e, t) => ({ ...(0, o.Cp)(e), options: [e, t] }),
        w = (e, t) => ({ ...(0, o.Qo)(e), options: [e, t] }),
        k = (e, t) => ({ ...g(e), options: [e, t] });
    },
    97145: function (e, t, r) {
      ...
      function u() {
        let e = /android/i;
        return e.test(l()) || e.test(i());
      }
      function g() {
        return l().toLowerCase().startsWith("mac") && !navigator.maxTouchPoints;
      }
      function b(e, t) {
        let r = ["mouse", "pen"];
      ...
      function k(e) {
        return !!e && "combobox" === e.getAttribute("role") && x(e);
      }
    },
    37317: function (e, t, r) {
      ...
      function d(e) {
        return (
          !!o() && (e instanceof HTMLElement || e instanceof n(e).HTMLElement)
        );
      }
      function c(e) {
        return (
      ...
      function g(e) {
        let { overflow: t, overflowX: r, overflowY: o, display: a } = C(e);
        return /auto|scroll|overlay|hidden|clip/.test(t + o + r) && !u.has(a);
      }
      ...
      function w(e) {
        let t = v(),
          r = s(e) ? C(e) : e;
        return (
          m.some((e) => !!r[e] && "none" !== r[e]) ||
          (!!r.containerType && "normal" !== r.containerType) ||
          (!t && !!r.backdropFilter && "none" !== r.backdropFilter) ||
          (!t && !!r.filter && "none" !== r.filter) ||
          y.some((e) => (r.willChange || "").includes(e)) ||
          x.some((e) => (r.contain || "").includes(e))
        );
      }
      function k(e) {
        let t = S(e);
    ...
    71347: function (e, t, r) {
      ...
      let o = ["top", "right", "bottom", "left"],
        a = o.reduce((e, t) => e.concat(t, t + "-start", t + "-end"), []),
        n = Math.min,
        l = Math.max,
        i = Math.round,
        s = Math.floor,
          ...
          l =
            "x" === a
              ...
              : "start" === o
                ? "bottom"
                : "top";
        return (t.reference[n] > t.floating[n] && (l = E(l)), [l, E(l)]);
      }
      function v(e) {
        let t = E(e);
        return [j(e), t, j(t)];
      ...
      function R(e, t, r, o) {
        ...
        return (
          a && ((n = n.map((e) => e + "-" + a)), t && (n = n.concat(n.map(j)))),
          n
        );
      }
      function E(e) {
    ...
    13721: function (e, t, r) {
      ...
      function g(e, t) {
        if (c(t) && 0 === Object.keys(t).length) return u({ ...e, ...t });
        let r = { ...e, ...t };
        if (c(t) && c(e))
          for (let o in t)
            c(t[o]) && o in e && c(e[o])
        ...
        p = {
          ...
          dropdown: {
            ...
            toggle: {
              ...
              floating: {
                ...b.floating,
                base: (0, d.m6)(b.floating.base, "mt-2 block"),
                content: (0, d.m6)(
                  b.floating.content,
                ...
                style: {
                  ...b.floating.style,
                  auto: (0, d.m6)(
                    b.floating.style.auto,
                    "text-gray-500 dark:text-gray-400",
                  ),
                },
              },
              inlineWrapper: (0, d.m6)(
                b.inlineWrapper,
        ...
        h = {
          ...
          hr: {
            ...
            icon: {
              ...
              hrLine:
                "my-8 h-1 w-64 rounded border-0 bg-gray-200 dark:bg-gray-700",
              icon: {
      ...
      let w = (0, i.createContext)(void 0);
      function k() {
      ...
      let v = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { isOpen: a } = k(),
            n = g(x().accordion.content, r);
          return (0, l.jsx)("div", {
            className: (0, d.m6)(n.base, t),
        ...
        j = ({ children: e, ...t }) => {
          let { alwaysOpen: r } = t,
            [o, a] = (0, i.useState)(t.isOpen),
            n = r ? { ...t, isOpen: o, setOpen: () => a(!o) } : t;
          return (0, l.jsx)(w.Provider, { value: n, children: e });
        },
        N = ({
          as: e = "h2",
          children: t,
          ...
          let { arrowIcon: n, flush: i, isOpen: s, setOpen: c } = k(),
            u = g(x().accordion.title, o);
        ...
        C = ({
          ...
          let [b, f] = (0, i.useState)(a ? -1 : 0),
            p = (0, i.useMemo)(
              () =>
                i.Children.map(r, (r, a) =>
                  (0, i.cloneElement)(r, {
                    alwaysOpen: e,
                    arrowIcon: t,
                    flush: o,
            ...
            h = g(x().accordion.root, c);
          return (0, l.jsx)("div", {
            className: (0, d.m6)(h.base, h.flush[o ? "on" : "off"], n),
      ...
      ((C.displayName = "Accordion"),
        (j.displayName = "Accordion.Panel"),
        (N.displayName = "Accordion.Title"),
        (v.displayName = "Accordion.Content"),
        Object.assign(C, { Panel: j, Title: N, Content: v }));
      let T = ({ children: e, className: t, theme: r = {}, ...o }) => {
        let a = g(x().avatar.group, r);
        return (0, l.jsx)("div", {
          "data-testid": "avatar-group-element",
          className: (0, d.m6)(a.base, t),
          ...o,
          children: e,
        });
      };
      T.displayName = "Avatar.Group";
      let S = ({ className: e, href: t, theme: r = {}, total: o, ...a }) => {
        let n = g(x().avatar.groupCounter, r);
        return (0, l.jsxs)("a", {
          href: t,
          className: (0, d.m6)(n.base, e),
          ...a,
          children: ["+", o],
        });
      };
      S.displayName = "Avatar.GroupCounter";
      let R = ({
        alt: e = "",
        bordered: t = !1,
        children: r,
        ...
        let m = g(x().avatar, p),
          ...
          w = {
            className: (0, d.m6)(y, m.root.img.on),
            "data-testid": "flowbite-avatar-img",
          };
        return (0, l.jsxs)("div", {
          className: (0, d.m6)(m.root.base, o),
                  ...
                  : i
                    ? (0, l.jsx)("div", {
                        ...
                        children: (0, l.jsx)("span", {
                          className: (0, d.m6)(m.root.initials.text),
                          "data-testid":
                    ...
                    : (0, l.jsx)("div", {
                        className: (0, d.m6)(y, m.root.img.off),
                        "data-testid": "flowbite-avatar-img",
      ...
      ((R.displayName = "Avatar"), Object.assign(R, { Group: T, Counter: S }));
      let E = ({
        children: e,
        color: t = "info",
        href: r,
            ...
            (0, l.jsxs)("span", {
              ...
              children: [
                o &&
                  (0, l.jsx)(o, {
                    "aria-hidden": !0,
                    className: c.icon.size[a],
                    "data-testid": "flowbite-badge-icon",
                  }),
                e && (0, l.jsx)("span", { children: e }),
              ],
            });
        return r
          ? (0, l.jsx)("a", {
      ...
      let z = (0, i.forwardRef)(
        ({ children: e, as: t, href: r, type: o = "button", ...a }, n) => {
          let l = t || (r ? "a" : "button");
          return (0, i.createElement)(l, { ref: n, href: r, type: o, ...a }, e);
        },
      );
      z.displayName = "ButtonBaseComponent";
      let I = (e, t, r) =>
          i.Children.map(e, (o, a) => {
            if ((0, i.isValidElement)(o)) {
              let n =
                o.type == O
                  ? { positionInGroup: M(a, i.Children.count(e)) }
                  : {};
              return o.props.children
                ? (0, i.cloneElement)(o, {
                    ...o.props,
                    children: I(o.props.children, t, r),
                    ...n,
                  })
                : (0, i.cloneElement)(o, { outline: t, pill: r, ...n });
            }
            return o;
          }),
        M = (e, t) => (0 === e ? "start" : e === t - 1 ? "end" : "middle"),
        P = ({
          children: e,
          className: t,
          outline: r,
          ...
          let s = (0, i.useMemo)(() => I(e, r, o), [e, r, o]),
            c = g(x().buttonGroup, a);
          return (0, l.jsx)("div", {
            className: (0, d.m6)(c.base, t),
            role: "group",
            ...n,
            children: s,
          });
        };
      P.displayName = "Button.Group";
        ...
        (
          ...
          return (0, l.jsx)(z, {
            ...
            className: (0, d.m6)(
              ...
              o && N.disabled,
              !c && !u && N.color[r],
              c && !u && N.gradientDuoTone[c],
              !c && u && N.gradient[u],
              f && (N.outline.color[r] ?? N.outline.color.default),
              N.pill[p ? "on" : "off"],
              a && N.fullSized,
              v.position[h],
              t,
            ...
            children: (0, l.jsx)("span", {
              className: (0, d.m6)(
                N.inner.base,
                N.outline[f ? "on" : "off"],
                N.outline.pill[f && p ? "on" : "off"],
                N.size[m],
                f && !N.outline.color[r] && N.inner.outline,
                n && N.isProcessing,
                n && N.inner.isProcessingPadding[m],
                N.inner.position[h],
              ),
                ...
                children: [
                  n &&
                    (0, l.jsx)("span", {
                      className: (0, d.m6)(
                        N.spinnerSlot,
                        N.spinnerLeftPosition[m],
                      ),
                      children: s || (0, l.jsx)(D, { size: m }),
                    }),
                  void 0 !== e
                    ? e
                    : (0, l.jsx)("span", {
                        "data-testid": "flowbite-button-label",
                        className: (0, d.m6)(N.label),
                        children: n ? i : b,
                      }),
                ],
              }),
      ...
      F.displayName = "Banner.CollapseButton";
      let A = ({ children: e, ...t }) =>
        (0, l.jsx)("div", {
      ...
      ((A.displayName = "Banner"), Object.assign(A, { CollapseButton: F }));
      let B = (0, i.forwardRef)(
        (
          { children: e, className: t, href: r, icon: o, theme: a = {}, ...n },
          i,
        ) => {
          let c = void 0 !== r,
            u = g(x().breadcrumb.item, a);
          return (0, l.jsxs)("li", {
            className: (0, d.m6)(u.base, t),
            ...n,
            children: [
              (0, l.jsx)(s.yoF, {
                "aria-hidden": !0,
              ...
              (0, l.jsxs)(c ? "a" : "span", {
                ref: i,
                className: u.href[c ? "on" : "off"],
                "data-testid": "flowbite-breadcrumb-item",
                href: r,
                children: [
                  o && (0, l.jsx)(o, { "aria-hidden": !0, className: u.icon }),
                  e,
                ],
              }),
            ],
      ...
      B.displayName = "Breadcrumb.Item";
      let W = ({ children: e, className: t, theme: r = {}, ...o }) => {
        let a = g(x().breadcrumb.root, r);
        return (0, l.jsx)("nav", {
          "aria-label": "Breadcrumb",
          className: (0, d.m6)(a.base, t),
          ...o,
          children: (0, l.jsx)("ol", { className: a.list, children: e }),
        });
      };
      ((W.displayName = "Breadcrumb"),
        Object.assign(W, { Item: B }),
        (o = [
          "renderImage",
          "imgSrc",
          "imgAlt",
      ...
      var Y = r(94712),
        ...
        H = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        V = (e, t, r) => H(e, "symbol" != typeof t ? t + "" : t, r);
      class q extends i.PureComponent {
        constructor(e) {
          (super(e),
            ...
            V(this, "onTouchStart", (e) => {
              let { nativeMobileScroll: t } = this.props;
              if (this.isDraggable(e.target)) {
                if (((this.internal = !0), t && this.scrolling))
                  this.pressed = !0;
                else {
                  let r = e.touches[0];
            ...
            V(this, "onTouchEnd", () => {
              let { nativeMobileScroll: e } = this.props;
              this.pressed &&
            ...
            V(this, "onTouchMove", (e) => {
              ...
              if (this.pressed && (!t || !this.isMobile)) {
                let t = e.touches[0];
                (t && this.processMove(t.clientX, t.clientY),
                  e.preventDefault(),
                  this.props.stopPropagation && e.stopPropagation());
              }
            }),
            V(this, "onMouseDown", (e) => {
              this.isDraggable(e.target) &&
                this.isScrollable() &&
                ((this.internal = !0),
                -1 !== this.props?.buttons?.indexOf(e.button) &&
                  (this.processClick(e.clientX, e.clientY),
                  e.preventDefault(),
                  this.props.stopPropagation && e.stopPropagation()));
            }),
            V(this, "onMouseMove", (e) => {
              this.pressed &&
            ...
            (this.onEndScroll = G(this.onEndScroll, 300)),
            (this.scrolling = !1),
            (this.started = !1),
            (this.pressed = !1),
            (this.internal = !1),
        ...
        processStart(e = !0) {
          let { onStartScroll: t } = this.props;
          ((this.started = !0),
            e && document.body.classList.add("cursor-grab"),
        ...
        processMove(e, t) {
          ...
          this.started
            ? (r && (l.scrollLeft -= e - this.clientX),
              o && (l.scrollTop -= t - this.clientY),
              n && n({ external: !this.internal }),
              (this.clientX = e),
              (this.clientY = t),
              (this.scrollLeft = l.scrollLeft),
              (this.scrollTop = l.scrollTop))
            : ((r && Math.abs(e - this.clientX) > a) ||
                (o && Math.abs(t - this.clientY) > a)) &&
              ((this.clientX = e), (this.clientY = t), this.processStart());
        }
        processEnd() {
          let { onEndScroll: e } = this.props,
            t = this.container.current;
          (t && e && e({ external: !this.internal }),
            (this.pressed = !1),
            (this.started = !1),
            (this.scrolling = !1),
            (this.internal = !1),
      ...
      let K = () => "undefined" != typeof window,
        X = (0, i.forwardRef)(
          ({ className: e, color: t = "default", theme: r = {}, ...o }, a) => {
            let n = g(x().checkbox, r);
            return (0, l.jsx)("input", {
              ref: a,
              type: "checkbox",
              className: (0, d.m6)(n.root.base, n.root.color[t], e),
              ...o,
            });
          },
        );
      ...
      var Q = r(93075),
        _ = r(58214),
        U = r(1371);
      let J = ({ arrowRef: e, placement: t }) => {
          let r = [];
          return (
            r.push((0, U.cv)(8)),
            r.push("auto" === t ? (0, U.X5)() : (0, U.RR)()),
            r.push((0, U.uY)({ padding: 8 })),
            e?.current && r.push((0, U.x7)({ element: e.current })),
            r
          );
        },
        Z = ({ placement: e }) => ("auto" === e ? void 0 : e),
        ee = ({ placement: e }) =>
          ({ top: "bottom", right: "left", bottom: "top", left: "right" })[
            e.split("-")[0]
          ],
        et = ({ open: e, arrowRef: t, placement: r = "top", setOpen: o }) =>
          (0, Q.YF)({
            placement: Z({ placement: r }),
            open: e,
            onOpenChange: o,
            whileElementsMounted: _.Me,
            middleware: J({ placement: r, arrowRef: t }),
          }),
        er = ({
          context: e,
          trigger: t,
          ...
          (0, Q.NI)([
            (0, Q.eS)(e, { enabled: "click" === t }),
            (0, Q.XI)(e, { enabled: "hover" === t, handleClose: (0, Q.xp)() }),
            (0, Q.bQ)(e),
            (0, Q.qs)(e, { role: r }),
            ...o,
          ]),
        eo = ({
          ...
          let f = (0, i.useRef)(null),
            [p, h] = (0, i.useState)(!1),
            m = et({ open: p, placement: n, arrowRef: f, setOpen: h }),
            {
              context: y,
            ...
            T = (0, Q.KK)(y),
            { getFloatingProps: S, getReferenceProps: R } = er({
              context: y,
              role: "tooltip",
              trigger: u,
              interactions: [T],
          ...
          return (
            (0, i.useEffect)(() => {
              if (k.reference.current && k.floating.current && p)
                return (0, _.Me)(k.reference.current, k.floating.current, j);
            }, [p, k.floating, k.reference, j]),
            (0, l.jsxs)(l.Fragment, {
              children: [
                (0, l.jsx)("div", {
                  ref: k.setReference,
                ...
                (0, l.jsxs)("div", {
                  ...
                  children: [
                    (0, l.jsx)("div", { className: c.content, children: a }),
                    t &&
                      (0, l.jsx)("div", {
                        className: (0, d.m6)(
                          c.arrow.base,
                          "dark" === s && c.arrow.style.dark,
                          "light" === s && c.arrow.style.light,
                          "auto" === s && c.arrow.style.auto,
                        ),
                        ...
                        style: {
                          ...
                          right: " ",
                          bottom: " ",
                          [ee({ placement: m.placement })]: c.arrow.placement,
                        },
                        children: "\xa0",
                      }),
                  ],
      ...
      let el = (e, t) => {
          (t(!0),
            navigator?.clipboard
              ...
              .catch((e) => {
                (console.error("Failed to Copy text: ", e), t(!1));
              }),
            setTimeout(() => t(!1), 4e3));
        },
        ei = (0, i.forwardRef)(
          (
            ...
            let [s, c] = (0, i.useState)(!1),
              u = g(x().clipboard.withIcon, r);
            return (0, l.jsx)("button", {
              className: (0, d.m6)(u.base, o),
              onClick: () => el(e, c),
              ...a,
              ref: n,
              children: s
                ? (0, l.jsx)(en.l_A, {
                    "aria-hidden": !0,
                    className: u.icon.successIcon,
                  })
                : (0, l.jsx)(t, {
                    "aria-hidden": !0,
                    className: u.icon.defaultIcon,
                  }),
            });
          },
        ),
        es = (0, i.forwardRef)(
          (
            ...
            let [c, u] = (0, i.useState)(!1),
              b = g(x().clipboard.withIconText, o);
            return (0, l.jsx)("button", {
              className: (0, d.m6)(b.base, a),
              onClick: () => el(e, u),
              ...n,
              ref: s,
              children: c
                ? (0, l.jsxs)("span", {
                    ...
                    children: [
                      (0, l.jsx)(en.l_A, {
                        "aria-hidden": !0,
                        className: b.icon.successIcon,
                      }),
                      (0, l.jsx)("span", {
                        className: b.label.successText,
                        children: "Copied",
                      }),
                    ],
                  })
                : (0, l.jsxs)("span", {
                    ...
                    children: [
                      (0, l.jsx)(t, {
                        "aria-hidden": !0,
                        className: b.icon.defaultIcon,
                      }),
                      (0, l.jsx)("span", {
                        className: b.label.defaultText,
                        children: r,
                      }),
                    ],
                  }),
        ...
        ed = (0, i.forwardRef)(
          (
            { className: e, valueToCopy: t, label: r, theme: o = {}, ...a },
            n,
          ) => {
            let [s, c] = (0, i.useState)(!1),
              u = g(x().clipboard.button, o);
            return (0, l.jsx)(ea, {
              content: s ? "Copied" : "Copy to clipboard",
              className: "[&_*]:cursor-pointer",
              children: (0, l.jsx)("button", {
                className: (0, d.m6)(u.base, e),
                onClick: () => el(t, c),
                ...a,
                ref: n,
                children: (0, l.jsx)("span", {
      ...
      ((ed.displayName = "Clipboard"),
        (ei.displayName = "Clipboard.WithIcon"),
        (es.displayName = "Clipboard.WithIconText"),
        Object.assign(ed, { WithIcon: ei, WithIconText: es }));
      let ec = ({ key: e, onChange: t }) => {
          function r({ key: r, newValue: o }) {
            r === e && t(o);
          }
          (0, i.useEffect)(
            () => (
        ...
        eu = "light",
        eg = "flowbite-theme-mode",
        eb = "flowbite-theme-mode-sync",
        ef = () => {
          let [e, t] = (0, i.useState)(ey(m.mode));
          ((0, i.useEffect)(() => {
            (eh(e), em(e));
          }, []),
            ec({
          ...
          let r = (e) => {
            (t(e),
              eh(e),
              em(e),
              document.dispatchEvent(new CustomEvent(eb, { detail: e })));
          };
          return {
            mode: e,
            computedMode: ex(e),
        ...
        ep = (e) => {
          (0, i.useEffect)(() => {
            ...
            return (
              document.addEventListener(eb, t),
              () => document.removeEventListener(eb, t)
            );
          }, []);
        },
        eh = (e) => localStorage.setItem(eg, e),
        em = (e) => {
          let t = ex(e);
          "dark" === t
        ...
        ek = ({
          ...
          let i = g(x().helperText, o);
          return (0, l.jsx)("p", {
            className: (0, d.m6)(i.root.base, i.root.colors[r], t),
            ...n,
            children: a ?? e ?? "",
          });
        };
      ek.displayName = "HelperText";
      let ev = (0, i.forwardRef)(
        (
          {
            addon: e,
            className: t,
          ...
          let p = g(x().textInput, c);
          return (0, l.jsxs)(l.Fragment, {
            children: [
              (0, l.jsxs)("div", {
                className: (0, d.m6)(p.base, t),
                children: [
                  e && (0, l.jsx)("span", { className: p.addon, children: e }),
                  (0, l.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, l.jsx)("input", {
                        className: (0, d.m6)(
                          ...
                          p.field.input.sizes[s],
                          p.field.input.withIcon[a ? "on" : "off"],
                          p.field.input.withRightIcon[n ? "on" : "off"],
              ...
              o && (0, l.jsx)(ek, { color: r, children: o }),
            ],
          });
        },
      );
      ev.displayName = "TextInput";
      let ej = (0, i.createContext)(void 0);
      function eN() {
        let e = (0, i.useContext)(ej);
        if (!e)
          throw Error(
      ...
      var eC =
          ...
          (a[(a.Months = 1)] = "Months"),
          (a[(a.Years = 2)] = "Years"),
          (a[(a.Decades = 3)] = "Decades"),
          a),
        eT =
          (((n = eT || {})[(n.Sunday = 0)] = "Sunday"),
          (n[(n.Monday = 1)] = "Monday"),
          (n[(n.Tuesday = 2)] = "Tuesday"),
          (n[(n.Wednesday = 3)] = "Wednesday"),
          (n[(n.Thursday = 4)] = "Thursday"),
          (n[(n.Friday = 5)] = "Friday"),
          (n[(n.Saturday = 6)] = "Saturday"),
          n);
      let eS = (e, t, r) => {
          let o = new Date(
            e.getFullYear(),
        ...
        eD = (e, t) => {
          let r = new Date(e.getFullYear(), e.getMonth(), 1),
            o = r.getDay(),
            a = o - t;
          return (a < 0 && (a += 7), eI(r, -a));
        },
        ez = (e, t) => {
          let r = [],
            o = new Date(0);
          o.setDate(o.getDate() - o.getDay() + t);
          let a = new Intl.DateTimeFormat(e, { weekday: "short" });
          for (let e = 0; e < 7; e++) r.push(a.format(eI(o, e)));
          return r;
        },
        eI = (e, t) => {
          let r = new Date(e);
        ...
        eL = (e, t, r) => {
          let o = { day: "numeric", month: "long", year: "numeric" };
          return (r && (o = r), new Intl.DateTimeFormat(e, o).format(t));
        },
        eO = (e, t) => {
          let r = e.getFullYear();
            ...
            children: [
              (0, l.jsx)("div", {
                ...
                children: b.map((e, t) =>
                  (0, l.jsx)(
                    "span",
                    { className: u.header.title, children: e },
                    t,
                  ),
                ),
              }),
        ...
        eB = ({ theme: e = {} }) => {
          let {
            ...
            c = g(t.views.decades, e),
            u = eO(r, 100);
          return (0, l.jsx)("div", {
            className: c.items.base,
            children: [...Array(12)].map((e, t) => {
              let g = u - 10 + 10 * t,
                b = new Date(r.getTime());
              b.setFullYear(g + (r.getFullYear() % 10));
              let f = new Date(g, 0, 1),
                p = eP(f, 9),
                h = o && eF(o, g),
                m = !eS(f, a, n) && !eS(p, a, n);
              return (0, l.jsx)(
                "button",
                {
                  ...
                  className: (0, d.m6)(
                    c.items.item.base,
                    h && c.items.item.selected,
                    m && c.items.item.disabled,
                  ),
                  onClick: () => {
                    m || (o && i(eP(r, g - o.getFullYear())), s(eC.Years));
                  },
                  children: g,
                },
                t,
        ...
        eW = ({ theme: e = {} }) => {
          ...
          return (0, l.jsx)("div", {
            ...
            children: [...Array(12)].map((e, t) => {
              let g = new Date();
              (g.setMonth(t, 1), g.setFullYear(n.getFullYear()));
              let b = eL(i, g, { month: "short" }),
                f = a && eR(a, g),
                p = !eS(g, r, o);
              return (0, l.jsx)(
                "button",
                {
                  ...
                  className: (0, d.m6)(
                    u.items.item.base,
                    f && u.items.item.selected,
                    p && u.items.item.disabled,
                  ),
                  onClick: () => {
                    p || (s(g), c(eC.Days));
                  },
          ...
          (
            {
              ...
              autoHide: o = !0,
              showClearButton: a = !0,
              labelClearButton: n = "Clear",
              showTodayButton: c = !0,
              labelTodayButton: u = "Today",
              defaultValue: b,
              minDate: f,
              maxDate: p,
              language: h = "en",
              weekStart: m = eT.Sunday,
              className: y,
              theme: w = {},
              onChange: k,
              label: v,
            ...
            let T = g(x().datepicker, w),
              S = b ? eE(b, f, p) : null,
              R = (0, i.useMemo)(() => (b ? eE(b, f, p) : new Date()), []),
              [E, D] = (0, i.useState)(t),
              [z, I] = (0, i.useState)(eC.Days),
              [M, P] = (0, i.useState)(j ?? S),
              [L, O] = (0, i.useState)(j ?? R),
              F = (0, i.useRef)(null),
              A = (0, i.useRef)(null),
              B = (e, t) => {
                (P(e),
                  (null === e || e) && k && k(e),
                  o && z === eC.Days && !0 == t && !r && D(!1));
              },
              W = () => {
                (B(S, !0), b && O(b));
              };
            ...
            let Y = () => {
              ...
              G = (e, t, r) => {
                switch (e) {
                  case eC.Days:
                    return new Date(eM(t, r));
                  case eC.Months:
                    return new Date(eP(t, r));
                  case eC.Years:
                    return new Date(eP(t, 10 * r));
                  case eC.Decades:
                    return new Date(eP(t, 100 * r));
                  default:
                    return new Date(eP(t, 10 * r));
                }
              };
            ((0, i.useEffect)(() => {
              let e = (e) => {
                let t = A?.current?.contains(e.target),
                  r = F?.current?.contains(e.target);
                t || r || D(!1);
              };
              return (
              ...
              (0, i.useEffect)(() => {
                let e = j && eE(new Date(j), f, p),
                  t = M && eE(new Date(M), f, p);
                (t && e && !eR(e, t) && P(e), null == M && P(S));
              }, [j, P, O, M]));
            let $ = null === j ? v : eL(h, M || new Date());
            return (0, l.jsx)(ej.Provider, {
              value: {
                ...
                selectedDate: M,
                setSelectedDate: P,
                changeSelectedDate: B,
              },
              children: (0, l.jsxs)("div", {
                className: (0, d.m6)(T.root.base, y),
                children: [
                  !r &&
                    (0, l.jsx)(ev, {
                      theme: T.root.input,
                        ...
                        children: [
                          (0, l.jsxs)("div", {
                            ...
                            children: [
                              e &&
                                (0, l.jsx)("div", {
                                  className: T.popup.header.title,
                                  children: e,
                                }),
                              (0, l.jsxs)("div", {
                                ...
                                children: [
                                  ...
                                  (0, l.jsx)("button", {
                                    ...
                                    children: (() => {
                                      switch (z) {
                                        case eC.Decades:
                                          return `${eO(L, 100) - 10} - ${eO(L, 100) + 100}`;
                                        case eC.Years:
                                          return `${eO(L, 10)} - ${eO(L, 10) + 11}`;
                                        case eC.Months:
                                          return eL(h, L, { year: "numeric" });
                                        case eC.Days:
                                        default:
                                          return eL(h, L, {
                                            month: "long",
      ...
      let eq = ({
        ...
        let d = (0, i.useId)(),
          { id: c, isOpen: u, onClose: b, theme: f } = eH(),
          p = g(f.header, o);
        return (0, l.jsxs)("div", {
          className: t,
          ...s,
          children: [
            ...
            (0, l.jsx)("span", {
              ...
              id: `flowbite-drawer-header-${d}`,
              children: e,
            }),
          ],
        });
      };
      eq.displayName = "Drawer.Header";
      let eK = ({ children: e, className: t, theme: r = {}, ...o }) => {
        let { theme: a } = eH(),
          n = g(a.items, r);
        return (0, l.jsx)("div", {
      ...
      let eX = ({
        ...
        return (
          ...
          (0, l.jsxs)(e$.Provider, {
            value: { theme: f, onClose: n, isOpen: s, id: b },
            children: [
              (0, l.jsx)("div", {
                "aria-modal": !0,
                "aria-describedby": `drawer-dialog-${b}`,
                role: "dialog",
                tabIndex: -1,
                "data-testid": "flowbite-drawer",
                className: (0, d.m6)(
                  f.root.base,
                  f.root.position[a][s ? "on" : "off"],
                  o && !s && f.root.edge,
                  r,
                ),
                ...u,
              ...
              s &&
                ...
                (0, l.jsx)("div", {
                  onClick: () => n(),
                  className: f.root.backdrop,
                }),
            ],
          })
        );
      };
      ((eX.displayName = "Drawer"),
        Object.assign(eX, { Header: eq, Items: eK }));
      let eQ = (0, i.createContext)(void 0);
      function e_() {
        let e = (0, i.useContext)(eQ);
        if (!e)
          throw Error(
      ...
      let eU = ({ className: e, theme: t = {}, ...r }) => {
          let { theme: o } = e_(),
            a = t.divider ?? o.floating.divider;
          return (0, l.jsx)("div", { className: (0, d.m6)(a, e), ...r });
        },
        eJ = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { theme: a } = e_(),
            n = r.header ?? a.floating.header;
          return (0, l.jsxs)(l.Fragment, {
            children: [
              (0, l.jsx)("div", {
                className: (0, d.m6)(n, t),
                ...o,
                children: e,
              }),
              (0, l.jsx)(eU, {}),
        ...
        eZ = (0, i.forwardRef)(
          (
            ...
            let { ref: s, index: c } = (0, Q.JA)({
              ...
              y = g(b.floating.item, a);
            return (0, l.jsx)("li", {
              role: "menuitem",
              className: y.container,
              children: (0, l.jsxs)(z, {
                ref: u,
                className: (0, d.m6)(y.base, t),
                ...n,
                ...h({
                  onClick: () => {
                    (o?.(), p && m(null));
                ...
                tabIndex: f === c ? 0 : -1,
                children: [r && (0, l.jsx)(r, { className: y.icon }), e],
              }),
            });
          },
        );
      eZ.displayName = "DropdownItem";
      let e0 = { top: s.lVW, right: s.yoF, bottom: s.kzR, left: s.PSe },
        e5 = ({
          refs: e,
          children: t,
          inline: r,
          ...
          if (
            ((0, i.useEffect)(() => {
              u.current && n?.(u.current.clientWidth);
            }, [u, n]),
            d)
          ) {
            let t = d(o);
        ...
        e1 = ({
          ...
          let [u, b] = (0, i.useState)(!1),
            ...
            v = (0, i.useRef)([]),
            j = g(x().dropdown, o),
            N = c["data-testid"] || "flowbite-dropdown-target",
            {
              placement: C = c.inline ? "bottom-start" : "bottom",
              trigger: T = "click",
              label: S,
              inline: R,
              arrowIcon: E = !0,
            ...
            ),
            {
              ...
              floatingStyles: P,
              refs: L,
            } = et({ open: u, setOpen: b, placement: C }),
            O = (0, Q.c0)(M, {
              listRef: k,
              activeIndex: f,
              selectedIndex: h,
          ...
          return (0, l.jsxs)(eQ.Provider, {
            ...
            children: [
              (0, l.jsxs)(e5, {
                ...
                theme: j,
                "data-testid": N,
                className: (0, d.m6)(j.floating.target, D.className),
                setButtonWidth: w,
                getReferenceProps: A,
                renderTrigger: n,
                children: [S, E && (0, l.jsx)(Y, { className: j.arrowIcon })],
              }),
              u &&
                (0, l.jsx)(Q.wD, {
                  context: M,
                  ...
                  children: (0, l.jsx)("div", {
                    ...
                    ...B({
                      className: (0, d.m6)(
                        j.floating.base,
                        j.floating.animation,
                        "duration-100",
                        !u && j.floating.hidden,
                        j.floating.style.auto,
                        t,
                      ),
                    }),
                    children: (0, l.jsx)(Q.vs, {
                      elementsRef: k,
                      labelsRef: v,
                      children: (0, l.jsx)("ul", {
                        className: j.content,
      ...
      ((e1.displayName = "Dropdown"),
        (eJ.displayName = "Dropdown.Header"),
        (eU.displayName = "Dropdown.Divider"));
      let e6 = Object.assign(e1, { Item: eZ, Header: eJ, Divider: eU }),
        e2 = (0, i.forwardRef)(
          (
            {
              className: e,
            ...
            let s = g(x().fileInput, a);
            return (0, l.jsxs)(l.Fragment, {
              children: [
                (0, l.jsx)("div", {
                  className: (0, d.m6)(s.root.base, e),
                  children: (0, l.jsx)("div", {
                ...
                r && (0, l.jsx)(ek, { color: t, children: r }),
              ],
            });
          },
        );
      e2.displayName = "FileInput";
      let e4 = (0, i.forwardRef)(
        (
          {
            label: e,
            helperText: t,
          ...
          let f = (0, i.useId)(),
            p = g(x().floatingLabel, s);
          return (0, l.jsxs)("div", {
            children: [
              (0, l.jsxs)("div", {
                className: (0, d.m6)("relative", "standard" === a ? "z-0" : ""),
                children: [
                  (0, l.jsx)("input", {
                    type: "text",
                    id: u.id ? u.id : "floatingLabel" + f,
                    "aria-describedby": "outlined_success_help",
                    className: (0, d.m6)(p.input[r][a][o], c),
                    placeholder: " ",
                  ...
                  (0, l.jsx)("label", {
                    ...
                    className: (0, d.m6)(p.label[r][a][o], c),
                    children: e,
                  }),
                ],
              }),
              (0, l.jsx)("p", {
                ...
                className: (0, d.m6)(p.helperText[r], c),
                children: t,
              }),
            ],
          });
      ...
      function e3({ mode: e }) {
        return (e && (m.mode = e), ef(), null);
      }
      function e9({ theme: e }) {
        return (y(e), null);
      }
      function e8({ mode: e, theme: t }) {
        return (0, l.jsxs)(l.Fragment, {
          children: [
            (0, l.jsx)(e3, { mode: e }),
            (0, l.jsx)(e9, { theme: t }),
      ...
      e4.displayName = "FloatingLabel";
      let te = ({ children: e, theme: t }) =>
        (0, l.jsxs)(l.Fragment, {
          children: [(0, l.jsx)(e8, { mode: t?.mode, theme: t?.theme }), e],
        });
      te.displayName = "Flowbite";
      let tt = ({
          alt: e,
          className: t,
          children: r,
          ...
          return (0, l.jsx)("div", {
            children: o
              ? (0, l.jsxs)("a", {
                  ...
                  ...s,
                  children: [
                    (0, l.jsx)("img", { alt: e, src: n, className: c.img }),
                    (0, l.jsx)("span", {
        ...
        tr = ({
          ...
          let i = g(x().footer.copyright, o);
          return (0, l.jsxs)("div", {
            "data-testid": "flowbite-footer-copyright",
            className: (0, d.m6)(i.base, t),
            ...n,
            children: [
              "\xa9 ",
              a,
              r
                ? (0, l.jsx)("a", { href: r, className: i.href, children: e })
                : (0, l.jsx)("span", {
        ...
        to = ({ className: e, theme: t = {}, ...r }) => {
          let o = g(x().footer.divider, t);
          return (0, l.jsx)("hr", {
            "data-testid": "footer-divider",
            className: (0, d.m6)(o.base, e),
            ...r,
          });
        },
        ta = ({
          ...
          return (0, l.jsx)("div", {
            children: r
              ? (0, l.jsx)("a", {
                  ...
                  className: (0, d.m6)(i.base, t),
                  ...n,
                  children: (0, l.jsx)(o, { className: i.size }),
                })
              : (0, l.jsx)(o, {
                  "data-testid": "flowbite-footer-icon",
                  className: i.size,
        ...
        tn = ({
          ...
          let i = g(x().footer.groupLink.link, a);
          return (0, l.jsx)("li", {
            className: (0, d.m6)(i.base, r),
            children: (0, l.jsx)(e, {
              href: o,
              className: i.href,
              ...n,
        ...
        tl = ({
          ...
          let n = g(x().footer.groupLink, o);
          return (0, l.jsx)("ul", {
            "data-testid": "footer-groupLink",
            className: (0, d.m6)(n.base, r && n.col, t),
            ...a,
            children: e,
          });
        },
      ...
      ((ts.displayName = "Footer"),
        (tr.displayName = "Footer.Copyright"),
        (tn.displayName = "Footer.Link"),
        (tt.displayName = "Footer.Brand"),
        (tl.displayName = "Footer.LinkGroup"),
        (ta.displayName = "Footer.Icon"),
        (ti.displayName = "Footer.Title"),
        (to.displayName = "Footer.Divider"),
        Object.assign(ts, {
          Copyright: tr,
          Link: tn,
          LinkGroup: tl,
      ...
      let td = (0, i.forwardRef)(
          ({ theme: e = {}, icon: t = en.tLl, className: r, ...o }, a) => {
            let n = g(x().hr.icon, e);
            return (0, l.jsxs)("div", {
              className: n.base,
              children: [
                (0, l.jsx)("hr", {
                  className: (0, d.m6)(n.hrLine, r),
                  role: "separator",
                ...
                (0, l.jsx)("div", {
                  className: n.icon.base,
                  children: (0, l.jsx)(t, {
                    "aria-hidden": !0,
                    className: n.icon.icon,
                  }),
                }),
              ],
            });
        ...
        tc = (0, i.forwardRef)(({ theme: e = {}, className: t, ...r }, o) => {
          let a = g(x().hr.square, e);
          return (0, l.jsx)("hr", {
            className: (0, d.m6)(a.base, t),
            role: "separator",
        ...
        tu = (0, i.forwardRef)(
          ({ theme: e = {}, text: t, className: r, ...o }, a) => {
            let n = g(x().hr.text, e);
            return (0, l.jsxs)("div", {
              className: n.base,
              children: [
                ...
                (0, l.jsx)("span", { className: n.text, children: t }),
              ],
            });
          },
        ),
        tg = (0, i.forwardRef)(({ theme: e = {}, className: t, ...r }, o) => {
          let a = g(x().hr.trimmed, e);
          return (0, l.jsx)("hr", {
            className: (0, d.m6)(a.base, t),
            role: "separator",
        ...
        tb = (0, i.forwardRef)(({ theme: e = {}, className: t, ...r }, o) => {
          let a = g(x().hr.root, e);
          return (0, l.jsx)("hr", {
            className: (0, d.m6)(a.base, t),
            role: "separator",
      ...
      ((tb.displayName = "HR"),
        (tg.displayName = "HR.Trimmed"),
        (td.displayName = "HR.Icon"),
        (tu.displayName = "HR.Text"),
        (tc.displayName = "HR.Square"),
        Object.assign(tb, { Trimmed: tg, Icon: td, Text: tu, Square: tc }));
      let tf = ({
        children: e,
        className: t,
        color: r = "default",
      ...
      let tp = ({
          ...
          let n = g(x().list.item, o);
          return (0, l.jsxs)("li", {
            className: (0, d.m6)(n.withIcon[r ? "on" : "off"], t),
            ...a,
            children: [r && (0, l.jsx)(r, { className: (0, d.m6)(n.icon) }), e],
          });
        },
        th = ({
          children: e,
          ...
          let c = g(x().list, i);
          return (0, l.jsx)(a ? "ol" : "ul", {
            className: (0, d.m6)(
              c.root.base,
              c.root.ordered[a ? "on" : "off"],
              r && c.root.unstyled,
              o && c.root.nested,
              n && c.root.horizontal,
              t,
      ...
      ((th.displayName = "List"),
        (tp.displayName = "List.Item"),
        Object.assign(th, { Item: tp }));
      let tm = ({
          active: e,
          children: t,
          className: r,
          ...
          let u = g(x().listGroup.item, i),
            b = void 0 !== o;
          return (0, l.jsx)("li", {
            className: (0, d.m6)(u.base, r),
            children: (0, l.jsxs)(b ? "a" : "button", {
              href: o,
              onClick: n,
              type: b ? void 0 : "button",
              disabled: s,
              className: (0, d.m6)(
                u.link.active[e ? "on" : "off"],
                u.link.disabled[s ? "on" : "off"],
                u.link.base,
                u.link.href[b ? "on" : "off"],
              ),
              ...c,
              children: [
                a &&
        ...
        ty = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let a = g(x().listGroup, r);
          return (0, l.jsx)("ul", {
            className: (0, d.m6)(a.root.base, t),
            ...o,
            children: e,
          });
        };
      ((ty.displayName = "ListGroup"),
        (tm.displayName = "ListGroup.Item"),
        Object.assign(ty, { Item: tm }));
      let tx = (0, i.createContext)(void 0);
      function tw() {
        let e = (0, i.useContext)(tx);
        if (!e)
          throw Error(
      ...
      let tk = ({
        ...
        tv = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { theme: a, isOpen: n } = tw(),
            i = g(a.collapse, r);
          return (0, l.jsx)("div", {
            "data-testid": "flowbite-navbar-collapse",
            className: (0, d.m6)(i.base, i.hidden[n ? "off" : "on"], t),
            ...o,
            children: (0, l.jsx)("ul", { className: i.list, children: e }),
          });
        },
        tj = ({
          active: e,
      ...
      var tN = r(97875);
      let tC = ({ barIcon: e = tN.Fm7, className: t, theme: r = {}, ...o }) => {
          let { theme: a, isOpen: n, setIsOpen: i } = tw(),
            s = g(a.toggle, r);
          return (0, l.jsxs)("button", {
            ...
            children: [
              ...
              (0, l.jsx)(e, { "aria-hidden": !0, className: s.icon }),
            ],
          });
        },
        tT = ({
          ...
          let [u, b] = (0, i.useState)(a),
            f = g(x().navbar, s);
          return (0, l.jsx)(tx.Provider, {
            value: { theme: f, isOpen: u, setIsOpen: b },
            children: (0, l.jsx)("nav", {
              className: (0, d.m6)(
                f.root.base,
                f.root.bordered[e ? "on" : "off"],
                f.root.rounded[n ? "on" : "off"],
                r,
              ),
              ...c,
              children: (0, l.jsx)("div", {
      ...
      ((tT.displayName = "Navbar"),
        (tk.displayName = "Navbar.Brand"),
        (tv.displayName = "Navbar.Collapse"),
        (tj.displayName = "Navbar.Link"),
        (tC.displayName = "Navbar.Toggle"));
      let tS = Object.assign(tT, {
          Brand: tk,
          Collapse: tv,
          Link: tj,
          Toggle: tC,
        ...
        tR = ({
          ...
          let [n, s] = (0, i.useState)(void 0),
            c = g(x().megaMenu.dropdown, r);
          if (o)
            return (0, l.jsx)(e6, {
              inline: !0,
              label: o,
          ...
          return (
            (0, i.useEffect)(() => {
              s(
                (function () {
                  let e = b.current?.closest("nav");
                  return e?.querySelector('[aria-haspopup="menu"]');
                })()?.id,
              );
            }, []),
            (0, l.jsx)("div", {
      ...
      tR.displayName = "MegaMenu.Dropdown";
      let tE = ({ children: e, className: t, theme: r = {}, ...o }) => {
        let a = (0, i.useId)(),
          n = (0, i.useRef)(null),
          [s, c] = (0, i.useState)(void 0),
          [u, b] = (0, i.useState)(void 0),
          f = g(x().megaMenu.dropdownToggle, r),
          p = function () {
            let e = n.current?.closest("nav");
            return e?.querySelector('[role="menu"]');
          };
        return (
          (0, i.useEffect)(() => {
            let e = p(),
              t = e?.classList.contains("hidden");
            (c(e?.id), b(!t));
          }, []),
          (0, l.jsx)("button", {
            "aria-controls": s,
            ...
            id: a,
            onClick: function () {
              (p()?.classList.toggle("hidden"), b(!u));
            },
            ref: n,
            className: (0, d.m6)(f.base, t),
            ...o,
            children: e,
          })
        );
      };
      tE.displayName = "MegaMenu.DropdownToggle";
      let tD = ({ children: e, theme: t = {}, ...r }) => {
        let o = g(x().megaMenu, t);
        return (0, l.jsx)(tS, { fluid: !0, theme: o, ...r, children: e });
      };
      (Object.assign(tD, { Dropdown: tR, DropdownToggle: tE }),
        (tD.displayName = "MegaMenu"));
      let tz = (0, i.createContext)(void 0);
      function tI() {
        let e = (0, i.useContext)(tz);
        if (!e)
          throw Error(
      ...
      let tM = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { theme: a, popup: n } = tI(),
            i = g(a.body, r);
          return (0, l.jsx)("div", {
            className: (0, d.m6)(i.base, n && [i.popup], t),
            ...o,
            children: e,
          });
        },
        tP = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { theme: a, popup: n } = tI(),
            i = g(a.footer, r);
          return (0, l.jsx)("div", {
            className: (0, d.m6)(i.base, !n && i.popup, t),
        ...
        tL = ({
          ...
          let c = (0, i.useId)(),
            u = a || c,
            { theme: b, popup: f, onClose: p, setHeaderId: h } = tI(),
            m = g(b.header, o);
          return (
            (0, i.useLayoutEffect)(() => (h(u), () => h(void 0)), [u, h]),
            (0, l.jsxs)("div", {
              className: (0, d.m6)(m.base, f && m.popup, r),
              ...n,
              children: [
                (0, l.jsx)(e, { id: u, className: m.title, children: t }),
                (0, l.jsx)("button", {
                  "aria-label": "Close",
                  className: m.close.base,
                  type: "button",
                  onClick: p,
                  children: (0, l.jsx)(s.fMW, {
                    "aria-hidden": !0,
        ...
        tO = (0, i.forwardRef)(
          (
            ...
            let [m, y] = (0, i.useState)(void 0),
              w = g(x().modal, b),
              { context: k } = (0, Q.YF)({
                open: c,
                onOpenChange: () => o && o(),
              }),
              v = (0, Q.qq)([k.refs.setFloating, h]),
              j = (0, Q.eS)(k),
              N = (0, Q.bQ)(k, { outsidePressEvent: "mousedown", enabled: r }),
              C = (0, Q.qs)(k),
              { getFloatingProps: T } = (0, Q.NI)([j, N, C]);
            return c
              ? (0, l.jsx)(tz.Provider, {
                  value: { theme: w, popup: a, onClose: o, setHeaderId: y },
                  children: (0, l.jsx)(Q.ll, {
                    root: s,
                    children: (0, l.jsx)(Q.y0, {
                      lockScroll: !0,
                      "data-testid": "modal-overlay",
                      className: (0, d.m6)(
                        w.root.base,
                        w.root.positions[n],
                        c ? w.root.show.on : w.root.show.off,
                        t,
                      ),
                      ...p,
                      children: (0, l.jsx)(Q.wD, {
                        context: k,
                        initialFocus: f,
                        children: (0, l.jsx)("div", {
                          ref: v,
                          ...T(p),
                          "aria-labelledby": m,
                          className: (0, d.m6)(w.content.base, w.root.sizes[u]),
                          children: (0, l.jsx)("div", {
      ...
      ((tO.displayName = "Modal"),
        (tL.displayName = "Modal.Header"),
        (tM.displayName = "Modal.Body"),
        (tP.displayName = "Modal.Footer"),
        Object.assign(tO, { Header: tL, Body: tM, Footer: tP }));
      let tF = (e, t) =>
        ...
        tA = ({
          ...
          let i = g(x().pagination, a);
          return (0, l.jsx)("button", {
            type: "button",
            className: (0, d.m6)(e && i.pages.selector.active, r),
            onClick: o,
            ...n,
            children: t,
          });
        };
      tA.displayName = "Pagination.Button";
      let tB = ({
        children: e,
        className: t,
        onClick: r,
        ...
        let i = g(x().pagination, o);
        return (0, l.jsx)("button", {
          type: "button",
          className: (0, d.m6)(a && i.pages.selector.disabled, t),
          disabled: a,
          onClick: r,
          ...n,
          children: e,
      ...
      tB.displayName = "Pagination.Navigation";
      let tW = ({
        className: e,
        currentPage: t,
        layout: r = "pagination",
        ...
        renderPaginationButton: i = (e) => (0, l.jsx)(tA, { ...e }),
        showIcons: c = !1,
        theme: u = {},
        totalPages: b,
        ...f
      }) => {
        let p = g(x().pagination, u),
          h = Math.min(Math.max("pagination" === r ? t + 2 : t + 4, 5), b),
          m = Math.max(1, h - 4);
        return (0, l.jsxs)("nav", {
          className: (0, d.m6)(p.base, e),
          ...f,
          children: [
            "table" === r &&
              (0, l.jsxs)("div", {
                  ...
                  children: (0, l.jsxs)(tB, {
                    ...
                    children: [
                      c &&
                        (0, l.jsx)(s.DEl, {
                          "aria-hidden": !0,
                          className: p.pages.previous.icon,
                        }),
                      n,
                    ],
                  }),
                  ...
                  tF(m, h).map((e) =>
                    (0, l.jsx)(
                      "li",
                      {
                        ...
                        children: i({
                          className: (0, d.m6)(
                            p.pages.selector.base,
                            t === e && p.pages.selector.active,
                          ),
                          active: e === t,
                          onClick: () => a(e),
                          children: e,
      ...
      ((tW.displayName = "Pagination"), Object.assign(tW, { Button: tA }));
      let tY = (0, i.forwardRef)(({ className: e, theme: t = {}, ...r }, o) => {
        let a = g(x().radio, t);
        return (0, l.jsx)("input", {
          ref: o,
          type: "radio",
          className: (0, d.m6)(a.root.base, e),
          ...r,
        });
      });
      tY.displayName = "Radio";
      let tG = (0, i.forwardRef)(
        ({ className: e, sizing: t = "md", theme: r = {}, ...o }, a) => {
          let n = g(x().rangeSlider, r);
          return (0, l.jsx)(l.Fragment, {
            children: (0, l.jsx)("div", {
              "data-testid": "flowbite-range-slider",
              className: (0, d.m6)(n.root.base, e),
              children: (0, l.jsx)("div", {
                className: n.field.base,
                children: (0, l.jsx)("input", {
                  ref: a,
                  type: "range",
                  className: (0, d.m6)(
                    n.field.input.base,
                    n.field.input.sizes[t],
                  ),
                  ...o,
                }),
              }),
      ...
      let t$ = ({
          ...
          let n = g(x().ratingAdvanced, o);
          return (0, l.jsxs)("div", {
            className: (0, d.m6)(n.base, t),
            ...a,
            children: [
              (0, l.jsx)("span", { className: n.label, children: e }),
              (0, l.jsx)("div", {
                className: n.progress.base,
                children: (0, l.jsx)("div", {
              ...
              (0, l.jsx)("span", {
                className: n.progress.label,
                children: `${r}%`,
              }),
            ],
          });
        },
        tH = (0, i.createContext)(void 0),
        tV = ({
          className: e,
          filled: t = !0,
          starIcon: r = s.xiv,
          ...
          let { theme: n, size: c = "sm" } = (function () {
              let e = (0, i.useContext)(tH);
              if (!e)
                throw Error(
          ...
          return (0, l.jsx)(r, {
            ...
            className: (0, d.m6)(u.sizes[c], u[t ? "filled" : "empty"], e),
            ...a,
          });
        },
        tq = ({
          ...
          let n = g(x().rating, o);
          return (0, l.jsx)(tH.Provider, {
            value: { theme: n, size: r },
            children: (0, l.jsx)("div", {
              className: (0, d.m6)(n.root.base, t),
              ...a,
              children: e,
            }),
          });
        };
      ((tq.displayName = "Rating"),
        (tV.displayName = "Rating.Star"),
        (t$.displayName = "Rating.Advanced"),
        Object.assign(tq, { Star: tV, Advanced: t$ }));
      let tK = (0, i.forwardRef)(
        (
          {
            addon: e,
            children: t,
          ...
          let f = g(x().select, c);
          return (0, l.jsxs)("div", {
            className: (0, d.m6)(f.base, r),
            children: [
              e && (0, l.jsx)("span", { className: f.addon, children: e }),
              (0, l.jsxs)("div", {
                ...
                children: [
                  n &&
                    (0, l.jsx)("div", {
                      ...
                      children: (0, l.jsx)(n, { className: f.field.icon.svg }),
                    }),
                  (0, l.jsx)("select", {
                    className: (0, d.m6)(
                      f.field.select.base,
                      f.field.select.colors[o],
                      f.field.select.sizes[s],
                      f.field.select.withIcon[n ? "on" : "off"],
                      f.field.select.withAddon[e ? "on" : "off"],
                      f.field.select.withShadow[i ? "on" : "off"],
                    ),
                    ...u,
                    ref: b,
                    children: t,
                  }),
                  a && (0, l.jsx)(ek, { color: o, children: a }),
                ],
              }),
            ],
          });
      ...
      let t_ = (0, i.createContext)(void 0),
        tU = ({
          children: e,
          className: t,
          icon: r,
          ...
          return (
            ...
            (0, l.jsxs)(
                ...
                }),
              {
                children: [
                  (0, l.jsxs)("button", {
                    id: `flowbite-sidebar-collapse-${f}`,
                    onClick: () => h(!p),
                    title: o,
                    type: "button",
                    className: (0, d.m6)(x.button, t),
                    ...b,
                    children: [
                      r &&
                        (0, l.jsx)(r, {
                  ...
                  (0, l.jsx)("ul", {
                    "aria-labelledby": `flowbite-sidebar-collapse-${f}`,
                    hidden: !p,
                    className: x.list,
                    children: (0, l.jsx)(t_.Provider, {
      ...
      tU.displayName = "Sidebar.Collapse";
      let tJ = ({
        children: e,
        color: t = "info",
        className: r,
        ...
        let { theme: n, isCollapsed: i } = tQ(),
          s = g(n.cta, o);
        return (0, l.jsx)("div", {
          "data-testid": "sidebar-cta",
          hidden: i,
          className: (0, d.m6)(s.base, s.color[t], r),
          ...a,
          children: e,
        });
      };
      tJ.displayName = "Sidebar.CTA";
      let tZ = ({
          id: e,
          theme: t,
          isCollapsed: r,
          ...
          (0, l.jsx)("li", {
            ...
            children: r
              ? (0, l.jsx)(ea, {
                  content: (0, l.jsx)(t0, { id: e, theme: t, children: o }),
                  placement: "right",
                  children: a,
                })
              : a,
          }),
        t0 = ({ id: e, theme: t, children: r }) =>
          (0, l.jsx)("span", {
            "data-testid": "flowbite-sidebar-item-content",
            id: `flowbite-sidebar-item-${e}`,
            className: (0, d.m6)(t.content.base),
            children: r,
          }),
        t5 = (0, i.forwardRef)(
          (
            ...
            let f = (0, i.useId)(),
              { theme: p, isCollapsed: h } = tQ(),
              { isInsideCollapse: m } = (function () {
                let e = (0, i.useContext)(t_);
                if (!e)
                  throw Error(
                ...
                children: [
                  a &&
                    (0, l.jsx)(a, {
                      ...
                      className: (0, d.m6)(y.icon?.base, e && y.icon?.active),
                    }),
                  h &&
                    !a &&
                    (0, l.jsx)("span", {
                  ...
                  !h && (0, l.jsx)(t0, { id: f, theme: y, children: r }),
                  !h &&
                    n &&
                    (0, l.jsx)(E, {
                      color: s,
      ...
      t5.displayName = "Sidebar.Item";
      let t1 = ({ children: e, className: t, theme: r = {}, ...o }) => {
        let { theme: a } = tQ(),
          n = g(a.itemGroup, r);
        return (0, l.jsx)("ul", {
      ...
      t1.displayName = "Sidebar.ItemGroup";
      let t6 = ({ children: e, className: t, theme: r = {}, ...o }) => {
        let { theme: a } = tQ(),
          n = g(a.items, r);
        return (0, l.jsx)("div", {
          className: (0, d.m6)(n.base, t),
      ...
      let t2 = ({
        ...
        return (0, l.jsxs)("a", {
          ...
          ...s,
          children: [
            (0, l.jsx)("img", { alt: a, src: o, className: f.img }),
            (0, l.jsx)("span", {
              className: f.collapsed[b ? "on" : "off"],
      ...
      let t4 = ({
        ...
        let s = g(x().sidebar, a);
        return (0, l.jsx)(tX.Provider, {
          value: { theme: s, isCollapsed: o },
          children: (0, l.jsx)(t, {
            "aria-label": "Sidebar",
            hidden: o && "hide" === r,
            className: (0, d.m6)(
              s.root.base,
              s.root.collapsed[o ? "on" : "off"],
              n,
            ),
            ...i,
            children: (0, l.jsx)("div", {
              className: s.root.inner,
              children: e,
            }),
          }),
        });
      ...
      let t7 = Object.assign(t4, {
        ...
        t3 = (0, i.createContext)(void 0),
        t9 = (0, i.createContext)(void 0);
      function t8() {
        let e = (0, i.useContext)(t9);
        if (!e)
          throw Error(
      ...
      let re = (0, i.forwardRef)(
        ({ children: e, className: t, theme: r = {}, ...o }, a) => {
          let { theme: n } = t8(),
            i = g(n.body, r);
          return (0, l.jsx)(t3.Provider, {
            value: { theme: i },
      ...
      re.displayName = "Table.Body";
      let rt = (0, i.forwardRef)(
        ({ children: e, className: t, theme: r = {}, ...o }, a) => {
          let { theme: n } = (function () {
              let e = (0, i.useContext)(t3);
              if (!e)
                throw Error(
      ...
      rt.displayName = "Table.Cell";
      let rr = (0, i.createContext)(void 0),
        ro = (0, i.forwardRef)(
          ({ children: e, className: t, theme: r = {}, ...o }, a) => {
            let { theme: n } = t8(),
              i = g(n.head, r);
            return (0, l.jsx)(rr.Provider, {
              value: { theme: i },
              children: (0, l.jsx)("thead", {
                className: (0, d.m6)(i.base, t),
                ref: a,
                ...o,
                children: (0, l.jsx)("tr", { children: e }),
              }),
            });
          },
        );
      ro.displayName = "Table.Head";
      let ra = (0, i.forwardRef)(
        ({ children: e, className: t, theme: r = {}, ...o }, a) => {
          let { theme: n } = (function () {
              let e = (0, i.useContext)(rr);
              if (!e)
                throw Error(
      ...
      ra.displayName = "Table.HeadCell";
      let rn = (0, i.forwardRef)(
        ({ children: e, className: t, theme: r = {}, ...o }, a) => {
          let { theme: n, hoverable: i, striped: s } = t8(),
            c = g(n.row, r);
          return (0, l.jsx)("tr", {
            ref: a,
            "data-testid": "table-row-element",
            className: (0, d.m6)(c.base, s && c.striped, i && c.hovered, t),
            ...o,
            children: e,
          });
        },
      );
      rn.displayName = "Table.Row";
      let rl = (0, i.forwardRef)(
        (
          {
            children: e,
            className: t,
          ...
          return (0, l.jsx)("div", {
            ...
            className: (0, d.m6)(s.root.wrapper),
            children: (0, l.jsxs)(t9.Provider, {
              value: { theme: s, striped: r, hoverable: o },
              children: [
                (0, l.jsx)("div", { className: (0, d.m6)(s.root.shadow, t) }),
                (0, l.jsx)("table", {
                  className: (0, d.m6)(s.root.base, t),
                  ...n,
                  ref: i,
                  children: e,
                }),
      ...
      let ri = ({ children: e, className: t }) =>
        (0, l.jsx)("div", { className: t, children: e });
      ri.displayName = "Tabs.Item";
      let rs = (0, i.forwardRef)(
        (
          {
            children: e,
            className: t,
          ...
          let c = g(x().tabs, a),
            u = (0, i.useId)(),
            b = (0, i.useMemo)(
              () => i.Children.map(i.Children.toArray(e), ({ props: e }) => e),
              [e],
            ),
            f = (0, i.useRef)([]),
            [p, h] = (0, i.useState)(
            ...
            v = ({ event: e, target: t }) => {
              ("ArrowLeft" === e.key && y(Math.max(0, m - 1)),
                "ArrowRight" === e.key && y(Math.min(b.length - 1, m + 1)),
                "Enter" === e.key && (w(t), y(t)));
            },
            j = c.tablist.tabitem.variant[o],
            N = c.tabitemcontainer.variant[o];
          return (
            (0, i.useEffect)(() => {
              f.current[m]?.focus();
            }, [m]),
            (0, i.useImperativeHandle)(s, () => ({ setActiveTab: w })),
            (0, l.jsxs)("div", {
              className: (0, d.m6)(c.base, t),
              children: [
                (0, l.jsx)("div", {
                  "aria-label": "Tabs",
                  role: "tablist",
                  className: (0, d.m6)(c.tablist.base, c.tablist.variant[o], t),
                  ...n,
                  children: b.map((e, t) =>
                    (0, l.jsxs)(
                      "button",
                      {
                        type: "button",
                        "aria-controls": `${u}-tabpanel-${t}`,
                        "aria-selected": t === p,
                        className: (0, d.m6)(
                          c.tablist.tabitem.base,
                          j.base,
                          t === p && j.active.on,
                          t !== p && !e.disabled && j.active.off,
                        ),
                        disabled: e.disabled,
                        id: `${u}-tab-${t}`,
                        onClick: () => k({ target: t }),
                        onKeyDown: (e) => v({ event: e, target: t }),
                        ref: (e) => (f.current[t] = e),
                        role: "tab",
                        tabIndex: t === m ? 0 : -1,
                        style: { zIndex: t === m ? 2 : 1 },
                        children: [
                          e.icon &&
                            (0, l.jsx)(e.icon, {
                ...
                (0, l.jsx)("div", {
                  className: (0, d.m6)(c.tabitemcontainer.base, N),
                  children: b.map((e, t) =>
                    (0, l.jsx)(
                      "div",
                      {
                        "aria-labelledby": `${u}-tab-${t}`,
      ...
      ((rs.displayName = "Tabs"), Object.assign(rs, { Item: ri }));
      let rd = (0, i.forwardRef)(
        (
          {
            className: e,
            color: t = "gray",
      ...
      let rc = (0, i.createContext)(void 0);
      function ru() {
        let e = (0, i.useContext)(rc);
        if (!e)
          throw Error(
      ...
      let rg = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { theme: a } = ru(),
            n = g(a.body, r);
          return (0, l.jsx)("div", {
            className: (0, d.m6)(n.base, t),
        ...
        rb = (0, i.createContext)(void 0);
      function rf() {
        let e = (0, i.useContext)(rb);
        if (!e)
          throw Error(
      ...
      let rp = (0, i.createContext)(void 0);
      function rh() {
        let e = (0, i.useContext)(rp);
        if (!e)
          throw Error(
      ...
      let rm = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { horizontal: a } = rf(),
            { theme: n } = rh(),
            i = g(n.content, r);
          return (0, l.jsx)(rc.Provider, {
            value: { theme: i },
            children: (0, l.jsx)("div", {
              "data-testid": "timeline-content",
              className: (0, d.m6)(
                i.root.base,
                a ? i.root.horizontal : i.root.vertical,
                t,
              ),
              ...o,
              children: e,
        ...
        ry = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { theme: a, horizontal: n } = rf(),
            i = g(a.item, r);
          return (0, l.jsx)(rp.Provider, {
            value: { theme: i },
            children: (0, l.jsx)("li", {
        ...
        rx = ({ children: e, className: t, icon: r, theme: o = {}, ...a }) => {
          let { horizontal: n } = rf(),
            { theme: i } = rh(),
            s = g(i.point, o);
          return (0, l.jsxs)("div", {
            "data-testid": "timeline-point",
            className: (0, d.m6)(n && s.horizontal, !n && s.vertical, t),
            ...a,
            children: [
              e,
              r
                ? (0, l.jsx)("span", {
                    className: (0, d.m6)(s.marker.icon.wrapper),
                    children: (0, l.jsx)(r, {
                      "aria-hidden": !0,
                      className: (0, d.m6)(s.marker.icon.base),
                    }),
                  })
                : (0, l.jsx)("div", {
                    className: (0, d.m6)(
                      n && s.marker.base.horizontal,
                      !n && s.marker.base.vertical,
                    ),
                  }),
              n && (0, l.jsx)("div", { className: (0, d.m6)(s.line) }),
            ],
          });
        },
        rw = ({ children: e, className: t, theme: r = {}, ...o }) => {
          let { theme: a } = ru(),
            n = g(a.time, r);
          return (0, l.jsx)("time", {
            className: (0, d.m6)(n.base, t),
        ...
        rv = ({
          ...
          let n = g(x().timeline, o);
          return (0, l.jsx)(rb.Provider, {
            value: { theme: n, horizontal: r },
            children: (0, l.jsx)("ol", {
              "data-testid": "timeline-component",
              className: (0, d.m6)(
                r && n.root.direction.horizontal,
                !r && n.root.direction.vertical,
                t,
              ),
              ...a,
              children: e,
      ...
      ((rv.displayName = "Timeline"),
        (ry.displayName = "Timeline.Item"),
        (rx.displayName = "Timeline.Point"),
        (rm.displayName = "Timeline.Content"),
        (rw.displayName = "Timeline.Time"),
        (rk.displayName = "Timeline.Title"),
        (rg.displayName = "Timeline.Body"),
        Object.assign(rv, {
          Item: ry,
          Point: rx,
          Content: rm,
      ...
      let rj = (0, i.createContext)(void 0),
        rN = ({
          className: e,
          onClick: t,
          theme: r = {},
          ...
          return (0, l.jsx)("button", {
            ...
            onClick: (e) => {
              ...
              (p(!b), setTimeout(() => h(!f), u));
            },
            type: "button",
            className: (0, d.m6)(m.base, e),
            ...n,
            children: (0, l.jsx)(o, { "aria-hidden": !0, className: m.icon }),
          });
        },
        rC = {
          75: "duration-75",
      ...
      ((rT.displayName = "Toast"),
        (rN.displayName = "Toast.Toggle"),
        Object.assign(rT, { Toggle: rN }));
      let rS = (0, i.forwardRef)(
        (
          {
            checked: e,
          ...
          return (0, l.jsxs)(l.Fragment, {
            children: [
              ...
              (0, l.jsxs)("button", {
                "aria-checked": e,
                "aria-labelledby": `${p}-flowbite-toggleswitch-label`,
                disabled: a,
                id: `${p}-flowbite-toggleswitch`,
                onClick: () => {
                  m();
                },
                onKeyDown: (e) => {
                ...
                children: [
                  ...
                  n?.length
                    ? (0, l.jsx)("span", {
                        ...
                        id: `${p}-flowbite-toggleswitch-label`,
      ...
      rS.displayName = "ToggleSwitch";
    },
    88896: function (e, t, r) {
      "use strict";
      r.d(t, {
        w_: function () {
          return c;
          ...
          o.createElement(
            ...
            (function e(t) {
              return (
                t &&
                t.map((t, r) =>
                  o.createElement(t.tag, d({ key: r }, t.attr), e(t.child)),
                )
              );
            })(e.child),
          );
      ...
      function u(e) {
        ...
        return void 0 !== n
          ? o.createElement(n.Consumer, null, (e) => t(e))
          : t(a);
      }
    },
    98388: function (e, t, r) {
      "use strict";
      r.d(t, {
        m6: function () {
          return O;
      ...
      let N = new Set(["length", "size", "percentage"]);
      function C(e) {
        return z(e, N, M);
      }
      function T(e) {
      ...
      let O = (function (e) {
          ...
          let a = (function (e, t) {
            ...
            return e
              ...
              .filter((e) => {
                ...
                return (
                  !l.has(n) &&
                  (l.add(n), a(r, o).forEach((e) => l.add(t + e)), !0)
                );
              })
              .reverse()
        ...
        let e = i("colors"),
          ...
          p = i("gradientColorStopPositions"),
          N = i("inset"),
          S = i("margin"),
          z = i("opacity"),
          I = i("padding"),
        ...
        return {
          ...
          theme: {
            ...
            gradientColorStopPositions: [k, m],
            inset: Y(),
            margin: Y(),
            opacity: U(),
            padding: G(),
          ...
          classGroups: {
            ...
            grow: [{ grow: Q() }],
            shrink: [{ shrink: Q() }],
            order: [{ order: ["first", "last", "none", w, v] }],
            "grid-cols": [{ "grid-cols": [D] }],
            "col-start-end": [{ col: ["auto", { span: ["full", w, v] }, v] }],
            "col-start": [{ "col-start": H() }],
            "col-end": [{ "col-end": H() }],
            "grid-rows": [{ "grid-rows": [D] }],
            "row-start-end": [{ row: ["auto", { span: [w, v] }, v] }],
            ...
            "text-decoration-thickness": [
              { decoration: ["auto", "from-font", h, m] },
            ],
            "underline-offset": [{ "underline-offset": ["auto", h, v] }],
            ...
            "outline-offset": [{ "outline-offset": [h, v] }],
            "outline-w": [{ outline: [h, m] }],
            "outline-color": [{ outline: [e] }],
            "ring-w": [{ ring: $() }],
            "ring-w-inset": ["ring-inset"],
            "ring-color": [{ ring: [e] }],
            "ring-opacity": [{ "ring-opacity": [z] }],
            "ring-offset-w": [{ "ring-offset": [h, m] }],
            ...
            contrast: [{ contrast: [d] }],
            "drop-shadow": [{ "drop-shadow": ["", "none", j, v] }],
