  ...
  [3046],
  {
    39601: function (e, t, n) {
      ...
      t.Z = function (e) {
        ...
        var T =
          ...
          Z = { small: 20, medium: 24, large: 32 }[v];
        return (0, d.jsx)("button", {
          ...
          children: z(n)
            ? (0, d.jsx)(a.Z, { style: { fontSize: Z, color: g } })
            : (0, d.jsx)(c.Z, { style: { fontSize: Z, color: g } }),
        });
      };
    },
    ...
    57066: function (e, t, n) {
      ...
      t.default = function (e) {
        ...
        var L = JSON.parse(h().decompress(h().decodeBase64(t.templateData))),
          D = (0, p.useState)(!0),
          I = D[0],
          B = D[1],
          ...
          M = F.hasEnvelope && F.preventScrollUntilOpened,
          V = (0, p.useState)(L),
          W = V[0],
          X = V[1],
          H = (0, p.useState)(0),
          ...
          function () {
            var e = function () {
              ...
              var e = parseInt(L.ROOT.props.width),
                ...
                c = L.ROOT.props,
                s = (c.editorViewportWidth, (0, r.Z)(c, E));
              ((a.ROOT = N(
                N({}, L.ROOT),
                {},
                { props: N(N({}, s), {}, { width: U, height: i }) },
              )),
                X(a),
                setTimeout(function () {
                  B(!1);
          ...
          children: [
            ...
            (0, Z.jsx)(m.Z, {
              ...
              children: (0, Z.jsx)(x.Z, {
                ...
                device: "pc",
                pageData: t,
                shouldPreventScroll: M,
                children: (0, Z.jsxs)(y.l, {
                  isProcessing: I,
                  className: "h-full",
                  scrollSpeed: 0.06,
                  initialDelay: 2e3,
                  rootBackground: W.ROOT.props.backgroundColor,
                  shouldPreventScroll: M,
                  children: [
                    I &&
                      (0, Z.jsx)("div", {
  ...
  function (e) {
    (e.O(
      ...
      [
        ...
        221, 6214, 1793, 8593, 1476, 818, 6199, 5435, 8238, 9730, 4304, 1637,
        9774, 2888, 179,
      ],
      function () {
        return e((e.s = 54443));
