  ...
  [3340],
  {
    ...
    40411: function (t, e, o) {
            ...
            [e]: Object.assign(
              Object.assign(
                Object.assign(Object.assign({}, (0, u.Wf)(t)), {
                  ...
                  [`${e}-count, ${e}-dot, ${E}-custom-component`]: {
                    position: "absolute",
                    top: 0,
                    insetInlineEnd: 0,
      ...
      var k = (t) => {
          ...
          if (
            ...
            let r = l + 10,
              a = [];
            for (let t = l; t <= r; t += 1) a.push(t);
            let i = u < s ? 1 : -1,
              d = a.findIndex((t) => t % 10 === c),
              m = i < 0 ? a.slice(0, d + 1) : a.slice(d);
            ((e = m.map((e, o) =>
              n.createElement(
                C,
                Object.assign({}, t, {
    ...
    63340: function (t, e, o) {
      ...
      var v = o(98423),
        ...
        P = (t) => {
          let {
            ...
            l = new I.E4("antFloatButtonMoveTopOut", {
              "0%": {
                transform: "translate3d(0, 0, 0)",
                transformOrigin: "0 0",
                opacity: 1,
            ...
            s = new I.E4("antFloatButtonMoveRightIn", {
              "0%": {
                transform: `translate3d(${(0, I.bf)(a(o).mul(-1).equal())}, 0, 0)`,
                transformOrigin: "0 0",
                opacity: 0,
              },
              "100%": {
            ...
            c = new I.E4("antFloatButtonMoveRightOut", {
              "0%": {
                transform: "translate3d(0, 0, 0)",
                transformOrigin: "0 0",
                opacity: 1,
            ...
            d = new I.E4("antFloatButtonMoveBottomIn", {
              "0%": {
                transform: `translate3d(0, ${(0, I.bf)(a(o).mul(-1).equal())}, 0)`,
                transformOrigin: "0 0",
                opacity: 0,
              },
              "100%": {
            ...
            u = new I.E4("antFloatButtonMoveBottomOut", {
              "0%": {
                transform: "translate3d(0, 0, 0)",
                transformOrigin: "0 0",
                opacity: 1,
            ...
            m = new I.E4("antFloatButtonMoveLeftIn", {
              "0%": {
                transform: `translate3d(${(0, I.bf)(o)}, 0, 0)`,
                transformOrigin: "0 0",
                opacity: 0,
              },
              "100%": {
            ...
            b = new I.E4("antFloatButtonMoveLeftOut", {
              "0%": {
                transform: "translate3d(0, 0, 0)",
                transformOrigin: "0 0",
                opacity: 1,
      ...
      let M = (t) => {
          ...
          return {
            ...
            [`${u}-top > ${u}-wrap`]: {
              flexDirection: "column",
              top: "auto",
              bottom: d(n).add(r).equal(),
              "&::after": {
                content: '""',
                position: "absolute",
                width: "100%",
                height: r,
                bottom: d(r).mul(-1).equal(),
              },
            },
            [`${u}-bottom > ${u}-wrap`]: {
              flexDirection: "column",
            ...
            [`${u}-square`]: {
              [`${o}-square`]: {
                ...
                "&:not(:last-child)": {
                  borderBottom: `${(0, I.bf)(t.lineWidth)} ${t.lineType} ${t.colorSplit}`,
                },
                [`${e}-badge`]: {
                  [`${e}-badge-count`]: {
                    top: d(d(s).add(l)).mul(-1).equal(),
                    insetInlineEnd: d(d(s).add(l)).mul(-1).equal(),
                  },
                },
              },
              [`${u}-wrap`]: {
            ...
            [`${u}-left > ${u}-wrap, ${u}-right > ${u}-wrap`]: {
              [`> ${o}-square`]: {
                ...
                "&:not(:last-child)": {
                  borderInlineEnd: `${(0, I.bf)(t.lineWidth)} ${t.lineType} ${t.colorSplit}`,
                },
              },
            },
        ...
        q = (t) => {
          ...
          return {
            [o]: Object.assign(Object.assign({}, (0, N.Wf)(t)), {
              border: "none",
              position: "fixed",
              cursor: "pointer",
              zIndex: d,
              ...
              [`${e}-badge`]: {
                ...
                [`${e}-badge-count`]: {
                  ...
                  top: u(l).mul(-1).equal(),
                  insetInlineEnd: u(l).mul(-1).equal(),
                },
              },
              [`${o}-body`]: {
                width: "100%",
                ...
                [`${o}-content`]: {
                  ...
                  justifyContent: "center",
                  alignItems: "center",
                  padding: `${(0, I.bf)(u(n).div(2).equal())} ${(0, I.bf)(n)}`,
                  [`${o}-icon`]: {
                    textAlign: "center",
                    margin: "auto",
                    width: r,
              ...
              [`${o}-body`]: {
                ...
                [`${o}-content`]: {
                  ...
                  [`${o}-description`]: {
                    display: "flex",
                    alignItems: "center",
                    lineHeight: (0, I.bf)(t.fontSizeLG),
                    color: t.colorText,
      ...
      var D = (0, R.I$)(
          ...
          (t) => ({
            dotOffsetInCircle: T(t.controlHeightLG / 2),
      ...
      var A = o(97937),
        ...
        Y = (t) => {
          ...
          let {
            ...
            [B, R, z] = D(I, N),
            T = `${I}-group`,
            Z = f && ["click", "hover"].includes(f),
            P = s && ["top", "left", "right", "bottom"].includes(s),
            M = c()(T, R, z, N, r, {
              [`${T}-rtl`]: "rtl" === E,
              [`${T}-${i}`]: i,
              [`${T}-${i}-shadow`]: !Z,
