    ...
    69260: function (e, t, n) {
      !(function (e, t, n) {
        ...
        var c = [
          ...
          p = function (e, t) {
                ...
                var t,
                  n =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ...
                      : {};
                if (L.current) {
                  null === (t = D.current) || void 0 === t || t.destroy();
                  var r = u(u(u({}, e), n), {}, { container: L.current });
                  return (
                    (D.current = o.default.loadAnimation(r)),
                    R(!!D.current),
                    function () {
                      var e;
            ...
            return (
              ...
              n.useEffect(
                function () {
                  D.current && (D.current.autoplay = !!f);
                },
                [f],
              ),
              n.useEffect(
                function () {
                  if (D.current) {
                    if (!d) {
                      D.current.resetSegments(!0);
                      return;
                    }
                    Array.isArray(d) &&
                      d.length &&
                      ((D.current.currentRawFrame < d[0] ||
                        D.current.currentRawFrame > d[1]) &&
                        (D.current.currentRawFrame = d[0]),
                      D.current.setSegment(d[0], d[1]));
                  }
                },
                [d],
              ),
              n.useEffect(
                function () {
                  var e = [
                    ...
                    { name: "loopComplete", handler: v },
                    { name: "enterFrame", handler: y },
                    { name: "segmentStart", handler: h },
                    { name: "config_ready", handler: g },
                    { name: "data_ready", handler: E },
              ...
              ),
              {
                ...
                play: function () {
                  var e;
                  null === (e = D.current) || void 0 === e || e.play();
                },
                stop: function () {
                  var e;
                ...
                setSpeed: function (e) {
                  var t;
                  null === (t = D.current) || void 0 === t || t.setSpeed(e);
                },
                ...
                setDirection: function (e) {
                  var t;
                  null === (t = D.current) || void 0 === t || t.setDirection(e);
                },
                ...
                setSubframe: function (e) {
                  var t;
                  null === (t = D.current) || void 0 === t || t.setSubframe(e);
                },
                  ...
                  switch ((r.stop(), o)) {
                    ...
                    case "cursor":
                      return (
                          ...
                          if (-1 !== n && -1 !== o) {
                            var a,
                              ...
                              f =
                                ((a = n),
                                (s = o),
                                (c = (u = l.getBoundingClientRect()).top),
                                (p = u.left),
                                {
                                  x: (a - p) / u.width,
                                  y: (s - c) / u.height,
                        ...
                        l.addEventListener("mouseout", u),
                        function () {
                          (l.removeEventListener("mousemove", s),
                            l.removeEventListener("mouseout", u));
                        }
                      );
                  }
              },
        ...
        (Object.defineProperty(e, "LottiePlayer", {
          ...
          (e.useLottie = p),
          (e.useLottieInteractivity = d),
          Object.defineProperty(e, "__esModule", { value: !0 }));
      })(t, n(11248), n(67294));
    },
    79281: function (e, t, n) {
      "use strict";
      n.d(t, {
        Z: function () {
          return S;
