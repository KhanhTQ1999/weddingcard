google.maps.__gjsload__("search", function (_) {
  var rwa = function (a) {
    ...
    qwa = function (a) {
      ...
      const d = [];
      a.tv().forEach((e) => {
        e.a && e.a.length >= 2 && d.push(new swa(e, b, c));
      });
      return d;
    },
    twa = class extends _.Sn {};
  var uwa = { ["1"]: {} },
    swa = class {
      constructor(a, b, c) {
        this.Mn = b;
      ...
      getAnchor() {
        if (!this.anchor) {
          ...
          this.anchor = _.Tr(
            new _.fr(
              (this.Mn.x * 256 + this.source.a[0]) / a,
              (this.Mn.y * 256 + this.source.a[1]) / a,
            ),
          ).toJSON();
        }
        return this.anchor;
      ...
      static enableFeatureMapEventsRasterOnly(a) {
        if (_.Rq[15]) {
          ...
          (() => {
            ...
            f.length && _.On(a, "addfeatures", f);
          })();
        }
      }
    };
  CH.enableFeatureMapEventsRasterOnly = CH.enableFeatureMapEventsRasterOnly;
  _.uo(CH.prototype, { map: _.nt });
  _.pa.google.maps.search = { GoogleLayer: CH };
  _.Ml("search", {});
});
